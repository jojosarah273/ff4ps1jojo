...
**C-written: 62.0% (1559 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1559/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1559 funcs, 62.0%)
- [x] 50% C-written (~1258 funcs) — DONE (1559 funcs, 62.0%)
- [ ] 75% C-written (~1887 funcs) (1559 so far)
...
| real-C (match pending) | 819 | 32.6% |
| asm shell (to do) | 957 | 38.0% |
| **total** | 2516 | 100% |
| **C-written** | **1559** | **62.0%** |
<!-- STATUS:END -->
