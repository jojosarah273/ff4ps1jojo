...
**C-written: 64.3% (1617 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1617/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1617 funcs, 64.3%)
- [x] 50% C-written (~1258 funcs) — DONE (1617 funcs, 64.3%)
- [ ] 75% C-written (~1887 funcs) (1617 so far)
...
| real-C (match pending) | 877 | 34.9% |
| asm shell (to do) | 899 | 35.7% |
| **total** | 2516 | 100% |
| **C-written** | **1617** | **64.3%** |
<!-- STATUS:END -->
