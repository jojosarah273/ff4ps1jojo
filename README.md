...
**C-written: 55.4% (1394 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1394/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1394 funcs, 55.4%)
- [x] 50% C-written (~1258 funcs) — DONE (1394 funcs, 55.4%)
- [ ] 75% C-written (~1887 funcs) (1394 so far)
...
| real-C (match pending) | 654 | 26.0% |
| asm shell (to do) | 1122 | 44.6% |
| **total** | 2516 | 100% |
| **C-written** | **1394** | **55.4%** |
<!-- STATUS:END -->
