...
**C-written: 55.1% (1387 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1387/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1387 funcs, 55.1%)
- [x] 50% C-written (~1258 funcs) — DONE (1387 funcs, 55.1%)
- [ ] 75% C-written (~1887 funcs) (1387 so far)
...
| real-C (match pending) | 647 | 25.7% |
| asm shell (to do) | 1129 | 44.9% |
| **total** | 2516 | 100% |
| **C-written** | **1387** | **55.1%** |
<!-- STATUS:END -->
