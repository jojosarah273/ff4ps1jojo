...
**C-written: 62.8% (1580 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1580/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1580 funcs, 62.8%)
- [x] 50% C-written (~1258 funcs) — DONE (1580 funcs, 62.8%)
- [ ] 75% C-written (~1887 funcs) (1580 so far)
...
| real-C (match pending) | 840 | 33.4% |
| asm shell (to do) | 936 | 37.2% |
| **total** | 2516 | 100% |
| **C-written** | **1580** | **62.8%** |
<!-- STATUS:END -->
