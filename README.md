...
**C-written: 55.9% (1407 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1407/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1407 funcs, 55.9%)
- [x] 50% C-written (~1258 funcs) — DONE (1407 funcs, 55.9%)
- [ ] 75% C-written (~1887 funcs) (1407 so far)
...
| real-C (match pending) | 667 | 26.5% |
| asm shell (to do) | 1109 | 44.1% |
| **total** | 2516 | 100% |
| **C-written** | **1407** | **55.9%** |
<!-- STATUS:END -->
