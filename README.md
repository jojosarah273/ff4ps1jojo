...
**C-written: 85.7% (2157 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (2157/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (2157 funcs, 85.7%)
- [x] 50% C-written (~1258 funcs) — DONE (2157 funcs, 85.7%)
- [x] 75% C-written (~1887 funcs) — DONE (2157 funcs, 85.7%)
...
| real-C (match pending) | 1417 | 56.3% |
| asm shell (to do) | 359 | 14.3% |
| **total** | 2516 | 100% |
| **C-written** | **2157** | **85.7%** |
<!-- STATUS:END -->
