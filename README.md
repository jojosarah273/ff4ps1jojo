...
**C-written: 57.3% (1441 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1441/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1441 funcs, 57.3%)
- [x] 50% C-written (~1258 funcs) — DONE (1441 funcs, 57.3%)
- [ ] 75% C-written (~1887 funcs) (1441 so far)
...
| real-C (match pending) | 701 | 27.9% |
| asm shell (to do) | 1075 | 42.7% |
| **total** | 2516 | 100% |
| **C-written** | **1441** | **57.3%** |
<!-- STATUS:END -->
