...
**C-written: 95.0% (2391 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (2391/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (2391 funcs, 95.0%)
...
| real-C (match pending) | 1651 | 65.6% |
| asm shell (to do) | 125 | 5.0% |
| **total** | 2516 | 100% |
| **C-written** | **2391** | **95.0%** |
<!-- STATUS:END -->
