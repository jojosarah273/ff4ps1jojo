...
**C-written: 65.1% (1639 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1639/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1639 funcs, 65.1%)
- [x] 50% C-written (~1258 funcs) — DONE (1639 funcs, 65.1%)
- [ ] 75% C-written (~1887 funcs) (1639 so far)
...
| real-C (match pending) | 899 | 35.7% |
| asm shell (to do) | 877 | 34.9% |
| **total** | 2516 | 100% |
| **C-written** | **1639** | **65.1%** |
<!-- STATUS:END -->
