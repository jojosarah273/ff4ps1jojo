...
**C-written: 57.6% (1450 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1450/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1450 funcs, 57.6%)
- [x] 50% C-written (~1258 funcs) — DONE (1450 funcs, 57.6%)
- [ ] 75% C-written (~1887 funcs) (1450 so far)
...
| real-C (match pending) | 710 | 28.2% |
| asm shell (to do) | 1066 | 42.4% |
| **total** | 2516 | 100% |
| **C-written** | **1450** | **57.6%** |
<!-- STATUS:END -->
