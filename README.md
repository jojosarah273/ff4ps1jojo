...
**C-written: 64.0% (1610 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1610/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1610 funcs, 64.0%)
- [x] 50% C-written (~1258 funcs) — DONE (1610 funcs, 64.0%)
- [ ] 75% C-written (~1887 funcs) (1610 so far)
...
| real-C (match pending) | 870 | 34.6% |
| asm shell (to do) | 906 | 36.0% |
| **total** | 2516 | 100% |
| **C-written** | **1610** | **64.0%** |
<!-- STATUS:END -->
