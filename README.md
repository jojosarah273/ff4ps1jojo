...
**C-written: 58.4% (1470 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1470/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1470 funcs, 58.4%)
- [x] 50% C-written (~1258 funcs) — DONE (1470 funcs, 58.4%)
- [ ] 75% C-written (~1887 funcs) (1470 so far)
...
| real-C (match pending) | 730 | 29.0% |
| asm shell (to do) | 1046 | 41.6% |
| **total** | 2516 | 100% |
| **C-written** | **1470** | **58.4%** |
<!-- STATUS:END -->
