...
**C-written: 60.8% (1529 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1529/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1529 funcs, 60.8%)
- [x] 50% C-written (~1258 funcs) — DONE (1529 funcs, 60.8%)
- [ ] 75% C-written (~1887 funcs) (1529 so far)
...
| real-C (match pending) | 789 | 31.4% |
| asm shell (to do) | 987 | 39.2% |
| **total** | 2516 | 100% |
| **C-written** | **1529** | **60.8%** |
<!-- STATUS:END -->
