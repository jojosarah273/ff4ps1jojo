...
**C-written: 75.4% (1897 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1897/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1897 funcs, 75.4%)
- [x] 50% C-written (~1258 funcs) — DONE (1897 funcs, 75.4%)
- [x] 75% C-written (~1887 funcs) — DONE (1897 funcs, 75.4%)
...
| real-C (match pending) | 1157 | 46.0% |
| asm shell (to do) | 619 | 24.6% |
| **total** | 2516 | 100% |
| **C-written** | **1897** | **75.4%** |
<!-- STATUS:END -->
