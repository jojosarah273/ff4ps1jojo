...
**C-written: 86.0% (2165 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (2165/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (2165 funcs, 86.0%)
- [x] 50% C-written (~1258 funcs) — DONE (2165 funcs, 86.0%)
- [x] 75% C-written (~1887 funcs) — DONE (2165 funcs, 86.0%)
...
| real-C (match pending) | 1425 | 56.6% |
| asm shell (to do) | 351 | 14.0% |
| **total** | 2516 | 100% |
| **C-written** | **2165** | **86.0%** |
<!-- STATUS:END -->
