...
**C-written: 72.1% (1813 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1813/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1813 funcs, 72.1%)
- [x] 50% C-written (~1258 funcs) — DONE (1813 funcs, 72.1%)
- [ ] 75% C-written (~1887 funcs) (1813 so far)
...
| real-C (match pending) | 1073 | 42.6% |
| asm shell (to do) | 703 | 27.9% |
| **total** | 2516 | 100% |
| **C-written** | **1813** | **72.1%** |
<!-- STATUS:END -->
