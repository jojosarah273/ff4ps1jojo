...
**C-written: 73.4% (1848 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1848/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1848 funcs, 73.4%)
- [x] 50% C-written (~1258 funcs) — DONE (1848 funcs, 73.4%)
- [ ] 75% C-written (~1887 funcs) (1848 so far)
...
| real-C (match pending) | 1108 | 44.0% |
| asm shell (to do) | 668 | 26.6% |
| **total** | 2516 | 100% |
| **C-written** | **1848** | **73.4%** |
<!-- STATUS:END -->
