...
**C-written: 80.4% (2022 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (2022/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (2022 funcs, 80.4%)
- [x] 50% C-written (~1258 funcs) — DONE (2022 funcs, 80.4%)
- [x] 75% C-written (~1887 funcs) — DONE (2022 funcs, 80.4%)
...
| real-C (match pending) | 1282 | 51.0% |
| asm shell (to do) | 494 | 19.6% |
| **total** | 2516 | 100% |
| **C-written** | **2022** | **80.4%** |
<!-- STATUS:END -->
