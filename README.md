...
**C-written: 59.2% (1489 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1489/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1489 funcs, 59.2%)
- [x] 50% C-written (~1258 funcs) — DONE (1489 funcs, 59.2%)
- [ ] 75% C-written (~1887 funcs) (1489 so far)
...
| real-C (match pending) | 749 | 29.8% |
| asm shell (to do) | 1027 | 40.8% |
| **total** | 2516 | 100% |
| **C-written** | **1489** | **59.2%** |
<!-- STATUS:END -->
