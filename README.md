...
**C-written: 56.8% (1428 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1428/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1428 funcs, 56.8%)
- [x] 50% C-written (~1258 funcs) — DONE (1428 funcs, 56.8%)
- [ ] 75% C-written (~1887 funcs) (1428 so far)
...
| real-C (match pending) | 688 | 27.3% |
| asm shell (to do) | 1088 | 43.2% |
| **total** | 2516 | 100% |
| **C-written** | **1428** | **56.8%** |
<!-- STATUS:END -->
