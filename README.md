...
**C-written: 76.5% (1924 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1924/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1924 funcs, 76.5%)
- [x] 50% C-written (~1258 funcs) — DONE (1924 funcs, 76.5%)
- [x] 75% C-written (~1887 funcs) — DONE (1924 funcs, 76.5%)
...
| real-C (match pending) | 1184 | 47.1% |
| asm shell (to do) | 592 | 23.5% |
| **total** | 2516 | 100% |
| **C-written** | **1924** | **76.5%** |
<!-- STATUS:END -->
