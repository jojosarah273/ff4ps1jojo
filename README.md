...
**C-written: 71.3% (1794 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1794/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1794 funcs, 71.3%)
- [x] 50% C-written (~1258 funcs) — DONE (1794 funcs, 71.3%)
- [ ] 75% C-written (~1887 funcs) (1794 so far)
...
| real-C (match pending) | 1054 | 41.9% |
| asm shell (to do) | 722 | 28.7% |
| **total** | 2516 | 100% |
| **C-written** | **1794** | **71.3%** |
<!-- STATUS:END -->
