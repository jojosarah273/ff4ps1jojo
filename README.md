...
**C-written: 51.3% (1290 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1290/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1290 funcs, 51.3%)
- [x] 50% C-written (~1258 funcs) — DONE (1290 funcs, 51.3%)
- [ ] 75% C-written (~1887 funcs) (1290 so far)
...
| real-C (match pending) | 550 | 21.9% |
| asm shell (to do) | 1226 | 48.7% |
| **total** | 2516 | 100% |
| **C-written** | **1290** | **51.3%** |
<!-- STATUS:END -->
