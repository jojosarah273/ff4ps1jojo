...
**C-written: 61.2% (1539 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1539/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1539 funcs, 61.2%)
- [x] 50% C-written (~1258 funcs) — DONE (1539 funcs, 61.2%)
- [ ] 75% C-written (~1887 funcs) (1539 so far)
...
| real-C (match pending) | 799 | 31.8% |
| asm shell (to do) | 977 | 38.8% |
| **total** | 2516 | 100% |
| **C-written** | **1539** | **61.2%** |
<!-- STATUS:END -->
