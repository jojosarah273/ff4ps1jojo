...
**C-written: 64.7% (1629 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1629/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1629 funcs, 64.7%)
- [x] 50% C-written (~1258 funcs) — DONE (1629 funcs, 64.7%)
- [ ] 75% C-written (~1887 funcs) (1629 so far)
...
| real-C (match pending) | 889 | 35.3% |
| asm shell (to do) | 887 | 35.3% |
| **total** | 2516 | 100% |
| **C-written** | **1629** | **64.7%** |
<!-- STATUS:END -->
