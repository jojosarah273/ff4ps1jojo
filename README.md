...
**C-written: 58.1% (1461 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1461/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1461 funcs, 58.1%)
- [x] 50% C-written (~1258 funcs) — DONE (1461 funcs, 58.1%)
- [ ] 75% C-written (~1887 funcs) (1461 so far)
...
| real-C (match pending) | 721 | 28.7% |
| asm shell (to do) | 1055 | 41.9% |
| **total** | 2516 | 100% |
| **C-written** | **1461** | **58.1%** |
<!-- STATUS:END -->
