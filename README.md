...
**C-written: 54.6% (1374 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1374/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1374 funcs, 54.6%)
- [x] 50% C-written (~1258 funcs) — DONE (1374 funcs, 54.6%)
- [ ] 75% C-written (~1887 funcs) (1374 so far)
...
| real-C (match pending) | 634 | 25.2% |
| asm shell (to do) | 1142 | 45.4% |
| **total** | 2516 | 100% |
| **C-written** | **1374** | **54.6%** |
<!-- STATUS:END -->
