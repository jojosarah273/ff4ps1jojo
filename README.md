...
**C-written: 97.5% (2452 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (2452/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (2452 funcs, 97.5%)
- [x] 50% C-written (~1258 funcs) — DONE (2452 funcs, 97.5%)
- [x] 75% C-written (~1887 funcs) — DONE (2452 funcs, 97.5%)
...
| real-C (match pending) | 1712 | 68.0% |
| asm shell (to do) | 64 | 2.5% |
| **total** | 2516 | 100% |
| **C-written** | **2452** | **97.5%** |
<!-- STATUS:END -->
