...
**C-written: 67.3% (1693 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1693/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1693 funcs, 67.3%)
- [x] 50% C-written (~1258 funcs) — DONE (1693 funcs, 67.3%)
- [ ] 75% C-written (~1887 funcs) (1693 so far)
...
| real-C (match pending) | 953 | 37.9% |
| asm shell (to do) | 823 | 32.7% |
| **total** | 2516 | 100% |
| **C-written** | **1693** | **67.3%** |
<!-- STATUS:END -->
