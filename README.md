...
**C-written: 57.5% (1447 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1447/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1447 funcs, 57.5%)
- [x] 50% C-written (~1258 funcs) — DONE (1447 funcs, 57.5%)
- [ ] 75% C-written (~1887 funcs) (1447 so far)
...
| real-C (match pending) | 707 | 28.1% |
| asm shell (to do) | 1069 | 42.5% |
| **total** | 2516 | 100% |
| **C-written** | **1447** | **57.5%** |
<!-- STATUS:END -->
