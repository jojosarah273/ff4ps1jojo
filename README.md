...
**C-written: 50.3% (1265 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1265/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1265 funcs, 50.3%)
- [x] 50% C-written (~1258 funcs) — DONE (1265 funcs, 50.3%)
- [ ] 75% C-written (~1887 funcs) (1265 so far)
...
| real-C (match pending) | 525 | 20.9% |
| asm shell (to do) | 1251 | 49.7% |
| **total** | 2516 | 100% |
| **C-written** | **1265** | **50.3%** |
<!-- STATUS:END -->
