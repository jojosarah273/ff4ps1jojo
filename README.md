...
**C-written: 69.6% (1752 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1752/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1752 funcs, 69.6%)
- [x] 50% C-written (~1258 funcs) — DONE (1752 funcs, 69.6%)
- [ ] 75% C-written (~1887 funcs) (1752 so far)
...
| real-C (match pending) | 1012 | 40.2% |
| asm shell (to do) | 764 | 30.4% |
| **total** | 2516 | 100% |
| **C-written** | **1752** | **69.6%** |
<!-- STATUS:END -->
