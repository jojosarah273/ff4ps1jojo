...
**C-written: 64.9% (1633 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1633/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1633 funcs, 64.9%)
- [x] 50% C-written (~1258 funcs) — DONE (1633 funcs, 64.9%)
- [ ] 75% C-written (~1887 funcs) (1633 so far)
...
| real-C (match pending) | 893 | 35.5% |
| asm shell (to do) | 883 | 35.1% |
| **total** | 2516 | 100% |
| **C-written** | **1633** | **64.9%** |
<!-- STATUS:END -->
