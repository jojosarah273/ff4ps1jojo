...
**C-written: 66.7% (1677 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1677/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1677 funcs, 66.7%)
- [x] 50% C-written (~1258 funcs) — DONE (1677 funcs, 66.7%)
- [ ] 75% C-written (~1887 funcs) (1677 so far)
...
| real-C (match pending) | 937 | 37.2% |
| asm shell (to do) | 839 | 33.3% |
| **total** | 2516 | 100% |
| **C-written** | **1677** | **66.7%** |
<!-- STATUS:END -->
