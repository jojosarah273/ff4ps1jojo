...
**C-written: 57.9% (1457 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1457/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1457 funcs, 57.9%)
- [x] 50% C-written (~1258 funcs) — DONE (1457 funcs, 57.9%)
- [ ] 75% C-written (~1887 funcs) (1457 so far)
...
| real-C (match pending) | 717 | 28.5% |
| asm shell (to do) | 1059 | 42.1% |
| **total** | 2516 | 100% |
| **C-written** | **1457** | **57.9%** |
<!-- STATUS:END -->
