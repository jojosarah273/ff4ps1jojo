...
**C-written: 70.3% (1769 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1769/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1769 funcs, 70.3%)
- [x] 50% C-written (~1258 funcs) — DONE (1769 funcs, 70.3%)
- [ ] 75% C-written (~1887 funcs) (1769 so far)
...
| real-C (match pending) | 1029 | 40.9% |
| asm shell (to do) | 747 | 29.7% |
| **total** | 2516 | 100% |
| **C-written** | **1769** | **70.3%** |
<!-- STATUS:END -->
