...
**C-written: 63.3% (1593 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1593/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1593 funcs, 63.3%)
- [x] 50% C-written (~1258 funcs) — DONE (1593 funcs, 63.3%)
- [ ] 75% C-written (~1887 funcs) (1593 so far)
...
| real-C (match pending) | 853 | 33.9% |
| asm shell (to do) | 923 | 36.7% |
| **total** | 2516 | 100% |
| **C-written** | **1593** | **63.3%** |
<!-- STATUS:END -->
