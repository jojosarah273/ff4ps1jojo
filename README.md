...
**C-written: 75.2% (1891 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1891/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1891 funcs, 75.2%)
- [x] 50% C-written (~1258 funcs) — DONE (1891 funcs, 75.2%)
- [x] 75% C-written (~1887 funcs) — DONE (1891 funcs, 75.2%)
...
| real-C (match pending) | 1151 | 45.7% |
| asm shell (to do) | 625 | 24.8% |
| **total** | 2516 | 100% |
| **C-written** | **1891** | **75.2%** |
<!-- STATUS:END -->
