...
**C-written: 42.9% (1079 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1079/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1079 funcs, 42.9%)
- [ ] 50% C-written (~1258 funcs) (1079 so far)
- [ ] 75% C-written (~1887 funcs) (1079 so far)
...
| real-C (match pending) | 339 | 13.5% |
| asm shell (to do) | 1437 | 57.1% |
| **total** | 2516 | 100% |
| **C-written** | **1079** | **42.9%** |
<!-- STATUS:END -->
