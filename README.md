...
**C-written: 77.7% (1956 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1956/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1956 funcs, 77.7%)
- [x] 50% C-written (~1258 funcs) — DONE (1956 funcs, 77.7%)
- [x] 75% C-written (~1887 funcs) — DONE (1956 funcs, 77.7%)
...
| real-C (match pending) | 1216 | 48.3% |
| asm shell (to do) | 560 | 22.3% |
| **total** | 2516 | 100% |
| **C-written** | **1956** | **77.7%** |
<!-- STATUS:END -->
