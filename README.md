...
**C-written: 54.0% (1358 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1358/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1358 funcs, 54.0%)
- [x] 50% C-written (~1258 funcs) — DONE (1358 funcs, 54.0%)
- [ ] 75% C-written (~1887 funcs) (1358 so far)
...
| real-C (match pending) | 618 | 24.6% |
| asm shell (to do) | 1158 | 46.0% |
| **total** | 2516 | 100% |
| **C-written** | **1358** | **54.0%** |
<!-- STATUS:END -->
