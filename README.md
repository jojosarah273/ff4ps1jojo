...
**C-written: 55.1% (1386 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1386/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1386 funcs, 55.1%)
- [x] 50% C-written (~1258 funcs) — DONE (1386 funcs, 55.1%)
- [ ] 75% C-written (~1887 funcs) (1386 so far)
...
| real-C (match pending) | 646 | 25.7% |
| asm shell (to do) | 1130 | 44.9% |
| **total** | 2516 | 100% |
| **C-written** | **1386** | **55.1%** |
<!-- STATUS:END -->
