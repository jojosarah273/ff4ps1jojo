...
**C-written: 59.7% (1502 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1502/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1502 funcs, 59.7%)
- [x] 50% C-written (~1258 funcs) — DONE (1502 funcs, 59.7%)
- [ ] 75% C-written (~1887 funcs) (1502 so far)
...
| real-C (match pending) | 762 | 30.3% |
| asm shell (to do) | 1014 | 40.3% |
| **total** | 2516 | 100% |
| **C-written** | **1502** | **59.7%** |
<!-- STATUS:END -->
