...
**C-written: 55.3% (1392 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1392/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1392 funcs, 55.3%)
- [x] 50% C-written (~1258 funcs) — DONE (1392 funcs, 55.3%)
- [ ] 75% C-written (~1887 funcs) (1392 so far)
...
| real-C (match pending) | 652 | 25.9% |
| asm shell (to do) | 1124 | 44.7% |
| **total** | 2516 | 100% |
| **C-written** | **1392** | **55.3%** |
<!-- STATUS:END -->
