...
**C-written: 62.9% (1582 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1582/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1582 funcs, 62.9%)
- [x] 50% C-written (~1258 funcs) — DONE (1582 funcs, 62.9%)
- [ ] 75% C-written (~1887 funcs) (1582 so far)
...
| real-C (match pending) | 842 | 33.5% |
| asm shell (to do) | 934 | 37.1% |
| **total** | 2516 | 100% |
| **C-written** | **1582** | **62.9%** |
<!-- STATUS:END -->
