...
**C-written: 58.0% (1459 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1459/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1459 funcs, 58.0%)
- [x] 50% C-written (~1258 funcs) — DONE (1459 funcs, 58.0%)
- [ ] 75% C-written (~1887 funcs) (1459 so far)
...
| real-C (match pending) | 719 | 28.6% |
| asm shell (to do) | 1057 | 42.0% |
| **total** | 2516 | 100% |
| **C-written** | **1459** | **58.0%** |
<!-- STATUS:END -->
