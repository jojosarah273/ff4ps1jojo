...
**C-written: 56.2% (1414 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1414/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1414 funcs, 56.2%)
- [x] 50% C-written (~1258 funcs) — DONE (1414 funcs, 56.2%)
- [ ] 75% C-written (~1887 funcs) (1414 so far)
...
| real-C (match pending) | 674 | 26.8% |
| asm shell (to do) | 1102 | 43.8% |
| **total** | 2516 | 100% |
| **C-written** | **1414** | **56.2%** |
<!-- STATUS:END -->
