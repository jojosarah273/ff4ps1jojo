...
**C-written: 81.5% (2050 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (2050/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (2050 funcs, 81.5%)
- [x] 50% C-written (~1258 funcs) — DONE (2050 funcs, 81.5%)
- [x] 75% C-written (~1887 funcs) — DONE (2050 funcs, 81.5%)
...
| real-C (match pending) | 1310 | 52.1% |
| asm shell (to do) | 466 | 18.5% |
| **total** | 2516 | 100% |
| **C-written** | **2050** | **81.5%** |
<!-- STATUS:END -->
