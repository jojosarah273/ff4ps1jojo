...
**C-written: 65.6% (1650 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1650/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1650 funcs, 65.6%)
- [x] 50% C-written (~1258 funcs) — DONE (1650 funcs, 65.6%)
- [ ] 75% C-written (~1887 funcs) (1650 so far)
...
| real-C (match pending) | 910 | 36.2% |
| asm shell (to do) | 866 | 34.4% |
| **total** | 2516 | 100% |
| **C-written** | **1650** | **65.6%** |
<!-- STATUS:END -->
