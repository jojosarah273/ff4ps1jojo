...
**C-written: 59.1% (1487 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1487/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1487 funcs, 59.1%)
- [x] 50% C-written (~1258 funcs) — DONE (1487 funcs, 59.1%)
- [ ] 75% C-written (~1887 funcs) (1487 so far)
...
| real-C (match pending) | 747 | 29.7% |
| asm shell (to do) | 1029 | 40.9% |
| **total** | 2516 | 100% |
| **C-written** | **1487** | **59.1%** |
<!-- STATUS:END -->
