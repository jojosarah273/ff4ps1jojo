...
**C-written: 59.0% (1484 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1484/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1484 funcs, 59.0%)
- [x] 50% C-written (~1258 funcs) — DONE (1484 funcs, 59.0%)
- [ ] 75% C-written (~1887 funcs) (1484 so far)
...
| real-C (match pending) | 744 | 29.6% |
| asm shell (to do) | 1032 | 41.0% |
| **total** | 2516 | 100% |
| **C-written** | **1484** | **59.0%** |
<!-- STATUS:END -->
