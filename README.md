...
**C-written: 72.3% (1819 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1819/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1819 funcs, 72.3%)
- [x] 50% C-written (~1258 funcs) — DONE (1819 funcs, 72.3%)
- [ ] 75% C-written (~1887 funcs) (1819 so far)
...
| real-C (match pending) | 1079 | 42.9% |
| asm shell (to do) | 697 | 27.7% |
| **total** | 2516 | 100% |
| **C-written** | **1819** | **72.3%** |
<!-- STATUS:END -->
