...
**C-written: 67.8% (1707 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1707/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1707 funcs, 67.8%)
- [x] 50% C-written (~1258 funcs) — DONE (1707 funcs, 67.8%)
- [ ] 75% C-written (~1887 funcs) (1707 so far)
...
| real-C (match pending) | 967 | 38.4% |
| asm shell (to do) | 809 | 32.2% |
| **total** | 2516 | 100% |
| **C-written** | **1707** | **67.8%** |
<!-- STATUS:END -->
