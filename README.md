...
**C-written: 74.4% (1873 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1873/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1873 funcs, 74.4%)
- [x] 50% C-written (~1258 funcs) — DONE (1873 funcs, 74.4%)
- [ ] 75% C-written (~1887 funcs) (1873 so far)
...
| real-C (match pending) | 1133 | 45.0% |
| asm shell (to do) | 643 | 25.6% |
| **total** | 2516 | 100% |
| **C-written** | **1873** | **74.4%** |
<!-- STATUS:END -->
