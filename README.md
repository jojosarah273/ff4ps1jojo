...
**C-written: 63.6% (1601 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1601/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1601 funcs, 63.6%)
- [x] 50% C-written (~1258 funcs) — DONE (1601 funcs, 63.6%)
- [ ] 75% C-written (~1887 funcs) (1601 so far)
...
| real-C (match pending) | 861 | 34.2% |
| asm shell (to do) | 915 | 36.4% |
| **total** | 2516 | 100% |
| **C-written** | **1601** | **63.6%** |
<!-- STATUS:END -->
