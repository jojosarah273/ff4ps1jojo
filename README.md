...
**C-written: 83.1% (2090 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (2090/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (2090 funcs, 83.1%)
- [x] 50% C-written (~1258 funcs) — DONE (2090 funcs, 83.1%)
- [x] 75% C-written (~1887 funcs) — DONE (2090 funcs, 83.1%)
...
| real-C (match pending) | 1350 | 53.7% |
| asm shell (to do) | 426 | 16.9% |
| **total** | 2516 | 100% |
| **C-written** | **2090** | **83.1%** |
<!-- STATUS:END -->
