...
**C-written: 61.2% (1541 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1541/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1541 funcs, 61.2%)
- [x] 50% C-written (~1258 funcs) — DONE (1541 funcs, 61.2%)
- [ ] 75% C-written (~1887 funcs) (1541 so far)
...
| real-C (match pending) | 801 | 31.8% |
| asm shell (to do) | 975 | 38.8% |
| **total** | 2516 | 100% |
| **C-written** | **1541** | **61.2%** |
<!-- STATUS:END -->
