...
**C-written: 50.8% (1279 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1279/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1279 funcs, 50.8%)
- [x] 50% C-written (~1258 funcs) — DONE (1279 funcs, 50.8%)
- [ ] 75% C-written (~1887 funcs) (1279 so far)
