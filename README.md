...
**C-written: 58.6% (1475 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1475/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1475 funcs, 58.6%)
- [x] 50% C-written (~1258 funcs) — DONE (1475 funcs, 58.6%)
- [ ] 75% C-written (~1887 funcs) (1475 so far)
