...
**C-written: 74.2% (1867 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1867/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1867 funcs, 74.2%)
- [x] 50% C-written (~1258 funcs) — DONE (1867 funcs, 74.2%)
- [ ] 75% C-written (~1887 funcs) (1867 so far)
...
| real-C (match pending) | 1127 | 44.8% |
| asm shell (to do) | 649 | 25.8% |
| **total** | 2516 | 100% |
| **C-written** | **1867** | **74.2%** |
<!-- STATUS:END -->
