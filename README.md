...
**C-written: 66.8% (1680 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1680/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1680 funcs, 66.8%)
- [x] 50% C-written (~1258 funcs) — DONE (1680 funcs, 66.8%)
- [ ] 75% C-written (~1887 funcs) (1680 so far)
...
| real-C (match pending) | 940 | 37.4% |
| asm shell (to do) | 836 | 33.2% |
| **total** | 2516 | 100% |
| **C-written** | **1680** | **66.8%** |
<!-- STATUS:END -->
