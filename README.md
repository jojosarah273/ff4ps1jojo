...
**C-written: 87.9% (2212 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (2212/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (2212 funcs, 87.9%)
- [x] 50% C-written (~1258 funcs) — DONE (2212 funcs, 87.9%)
- [x] 75% C-written (~1887 funcs) — DONE (2212 funcs, 87.9%)
...
| real-C (match pending) | 1472 | 58.5% |
| asm shell (to do) | 304 | 12.1% |
| **total** | 2516 | 100% |
| **C-written** | **2212** | **87.9%** |
<!-- STATUS:END -->
