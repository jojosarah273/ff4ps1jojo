...
**C-written: 88.8% (2233 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (2233/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (2233 funcs, 88.8%)
- [x] 50% C-written (~1258 funcs) — DONE (2233 funcs, 88.8%)
- [x] 75% C-written (~1887 funcs) — DONE (2233 funcs, 88.8%)
...
| real-C (match pending) | 1493 | 59.3% |
| asm shell (to do) | 283 | 11.2% |
| **total** | 2516 | 100% |
| **C-written** | **2233** | **88.8%** |
<!-- STATUS:END -->
