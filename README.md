...
**C-written: 70.6% (1776 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1776/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1776 funcs, 70.6%)
- [x] 50% C-written (~1258 funcs) — DONE (1776 funcs, 70.6%)
- [ ] 75% C-written (~1887 funcs) (1776 so far)
...
| real-C (match pending) | 1036 | 41.2% |
| asm shell (to do) | 740 | 29.4% |
| **total** | 2516 | 100% |
| **C-written** | **1776** | **70.6%** |
<!-- STATUS:END -->
