...
**C-written: 74.8% (1883 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1883/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1883 funcs, 74.8%)
- [x] 50% C-written (~1258 funcs) — DONE (1883 funcs, 74.8%)
- [ ] 75% C-written (~1887 funcs) (1883 so far)
...
| real-C (match pending) | 1143 | 45.4% |
| asm shell (to do) | 633 | 25.2% |
| **total** | 2516 | 100% |
| **C-written** | **1883** | **74.8%** |
<!-- STATUS:END -->
