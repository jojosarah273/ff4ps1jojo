...
**C-written: 58.3% (1468 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1468/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1468 funcs, 58.3%)
- [x] 50% C-written (~1258 funcs) — DONE (1468 funcs, 58.3%)
- [ ] 75% C-written (~1887 funcs) (1468 so far)
...
| real-C (match pending) | 728 | 28.9% |
| asm shell (to do) | 1048 | 41.7% |
| **total** | 2516 | 100% |
| **C-written** | **1468** | **58.3%** |
<!-- STATUS:END -->
