...
**C-written: 70.4% (1772 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1772/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1772 funcs, 70.4%)
- [x] 50% C-written (~1258 funcs) — DONE (1772 funcs, 70.4%)
- [ ] 75% C-written (~1887 funcs) (1772 so far)
...
| real-C (match pending) | 1032 | 41.0% |
| asm shell (to do) | 744 | 29.6% |
| **total** | 2516 | 100% |
| **C-written** | **1772** | **70.4%** |
<!-- STATUS:END -->
