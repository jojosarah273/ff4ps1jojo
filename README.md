...
**C-written: 75.6% (1902 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1902/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1902 funcs, 75.6%)
- [x] 50% C-written (~1258 funcs) — DONE (1902 funcs, 75.6%)
- [x] 75% C-written (~1887 funcs) — DONE (1902 funcs, 75.6%)
...
| real-C (match pending) | 1162 | 46.2% |
| asm shell (to do) | 614 | 24.4% |
| **total** | 2516 | 100% |
| **C-written** | **1902** | **75.6%** |
<!-- STATUS:END -->
