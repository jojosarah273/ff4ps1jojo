...
**C-written: 61.5% (1547 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1547/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1547 funcs, 61.5%)
- [x] 50% C-written (~1258 funcs) — DONE (1547 funcs, 61.5%)
- [ ] 75% C-written (~1887 funcs) (1547 so far)
...
| real-C (match pending) | 807 | 32.1% |
| asm shell (to do) | 969 | 38.5% |
| **total** | 2516 | 100% |
| **C-written** | **1547** | **61.5%** |
<!-- STATUS:END -->
