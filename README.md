...
**C-written: 56.1% (1412 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1412/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1412 funcs, 56.1%)
- [x] 50% C-written (~1258 funcs) — DONE (1412 funcs, 56.1%)
- [ ] 75% C-written (~1887 funcs) (1412 so far)
...
| real-C (match pending) | 672 | 26.7% |
| asm shell (to do) | 1104 | 43.9% |
| **total** | 2516 | 100% |
| **C-written** | **1412** | **56.1%** |
<!-- STATUS:END -->
