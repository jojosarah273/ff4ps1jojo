...
**C-written: 52.7% (1325 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1325/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1325 funcs, 52.7%)
- [x] 50% C-written (~1258 funcs) — DONE (1325 funcs, 52.7%)
- [ ] 75% C-written (~1887 funcs) (1325 so far)
...
| real-C (match pending) | 585 | 23.3% |
| asm shell (to do) | 1191 | 47.3% |
| **total** | 2516 | 100% |
| **C-written** | **1325** | **52.7%** |
<!-- STATUS:END -->
