...
**C-written: 61.3% (1543 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1543/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1543 funcs, 61.3%)
- [x] 50% C-written (~1258 funcs) — DONE (1543 funcs, 61.3%)
- [ ] 75% C-written (~1887 funcs) (1543 so far)
...
| real-C (match pending) | 803 | 31.9% |
| asm shell (to do) | 973 | 38.7% |
| **total** | 2516 | 100% |
| **C-written** | **1543** | **61.3%** |
<!-- STATUS:END -->
