...
**C-written: 56.5% (1422 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1422/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1422 funcs, 56.5%)
- [x] 50% C-written (~1258 funcs) — DONE (1422 funcs, 56.5%)
- [ ] 75% C-written (~1887 funcs) (1422 so far)
...
| real-C (match pending) | 682 | 27.1% |
| asm shell (to do) | 1094 | 43.5% |
| **total** | 2516 | 100% |
| **C-written** | **1422** | **56.5%** |
<!-- STATUS:END -->
