...
**C-written: 53.3% (1340 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1340/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1340 funcs, 53.3%)
- [x] 50% C-written (~1258 funcs) — DONE (1340 funcs, 53.3%)
- [ ] 75% C-written (~1887 funcs) (1340 so far)
...
| real-C (match pending) | 600 | 23.8% |
| asm shell (to do) | 1176 | 46.7% |
| **total** | 2516 | 100% |
| **C-written** | **1340** | **53.3%** |
<!-- STATUS:END -->
