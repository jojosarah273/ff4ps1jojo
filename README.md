...
**C-written: 83.8% (2109 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (2109/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (2109 funcs, 83.8%)
- [x] 50% C-written (~1258 funcs) — DONE (2109 funcs, 83.8%)
- [x] 75% C-written (~1887 funcs) — DONE (2109 funcs, 83.8%)
...
| real-C (match pending) | 1369 | 54.4% |
| asm shell (to do) | 407 | 16.2% |
| **total** | 2516 | 100% |
| **C-written** | **2109** | **83.8%** |
<!-- STATUS:END -->
