...
**C-written: 60.1% (1512 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1512/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1512 funcs, 60.1%)
- [x] 50% C-written (~1258 funcs) — DONE (1512 funcs, 60.1%)
- [ ] 75% C-written (~1887 funcs) (1512 so far)
...
| real-C (match pending) | 772 | 30.7% |
| asm shell (to do) | 1004 | 39.9% |
| **total** | 2516 | 100% |
| **C-written** | **1512** | **60.1%** |
<!-- STATUS:END -->
