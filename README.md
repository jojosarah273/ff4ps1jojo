...
**C-written: 63.1% (1587 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1587/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1587 funcs, 63.1%)
- [x] 50% C-written (~1258 funcs) — DONE (1587 funcs, 63.1%)
- [ ] 75% C-written (~1887 funcs) (1587 so far)
...
| real-C (match pending) | 847 | 33.7% |
| asm shell (to do) | 929 | 36.9% |
| **total** | 2516 | 100% |
| **C-written** | **1587** | **63.1%** |
<!-- STATUS:END -->
