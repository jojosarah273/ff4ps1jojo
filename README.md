...
**C-written: 60.4% (1519 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1519/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1519 funcs, 60.4%)
- [x] 50% C-written (~1258 funcs) — DONE (1519 funcs, 60.4%)
- [ ] 75% C-written (~1887 funcs) (1519 so far)
...
| real-C (match pending) | 779 | 31.0% |
| asm shell (to do) | 997 | 39.6% |
| **total** | 2516 | 100% |
| **C-written** | **1519** | **60.4%** |
<!-- STATUS:END -->
