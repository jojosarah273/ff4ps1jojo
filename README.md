...
**C-written: 61.5% (1548 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1548/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1548 funcs, 61.5%)
- [x] 50% C-written (~1258 funcs) — DONE (1548 funcs, 61.5%)
- [ ] 75% C-written (~1887 funcs) (1548 so far)
...
| real-C (match pending) | 808 | 32.1% |
| asm shell (to do) | 968 | 38.5% |
| **total** | 2516 | 100% |
| **C-written** | **1548** | **61.5%** |
<!-- STATUS:END -->
