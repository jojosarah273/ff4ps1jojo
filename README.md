...
**C-written: 60.0% (1510 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1510/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1510 funcs, 60.0%)
- [x] 50% C-written (~1258 funcs) — DONE (1510 funcs, 60.0%)
- [ ] 75% C-written (~1887 funcs) (1510 so far)
...
| real-C (match pending) | 770 | 30.6% |
| asm shell (to do) | 1006 | 40.0% |
| **total** | 2516 | 100% |
| **C-written** | **1510** | **60.0%** |
<!-- STATUS:END -->
