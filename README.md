...
**C-written: 54.1% (1361 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1361/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1361 funcs, 54.1%)
- [x] 50% C-written (~1258 funcs) — DONE (1361 funcs, 54.1%)
- [ ] 75% C-written (~1887 funcs) (1361 so far)
...
| real-C (match pending) | 621 | 24.7% |
| asm shell (to do) | 1155 | 45.9% |
| **total** | 2516 | 100% |
| **C-written** | **1361** | **54.1%** |
<!-- STATUS:END -->
