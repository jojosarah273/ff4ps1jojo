...
**C-written: 67.6% (1700 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1700/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1700 funcs, 67.6%)
- [x] 50% C-written (~1258 funcs) — DONE (1700 funcs, 67.6%)
- [ ] 75% C-written (~1887 funcs) (1700 so far)
...
| real-C (match pending) | 960 | 38.2% |
| asm shell (to do) | 816 | 32.4% |
| **total** | 2516 | 100% |
| **C-written** | **1700** | **67.6%** |
<!-- STATUS:END -->
