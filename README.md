...
**C-written: 60.7% (1528 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1528/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1528 funcs, 60.7%)
- [x] 50% C-written (~1258 funcs) — DONE (1528 funcs, 60.7%)
- [ ] 75% C-written (~1887 funcs) (1528 so far)
...
| real-C (match pending) | 788 | 31.3% |
| asm shell (to do) | 988 | 39.3% |
| **total** | 2516 | 100% |
| **C-written** | **1528** | **60.7%** |
<!-- STATUS:END -->
