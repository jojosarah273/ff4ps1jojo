...
**C-written: 67.4% (1696 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1696/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1696 funcs, 67.4%)
- [x] 50% C-written (~1258 funcs) — DONE (1696 funcs, 67.4%)
- [ ] 75% C-written (~1887 funcs) (1696 so far)
...
| real-C (match pending) | 956 | 38.0% |
| asm shell (to do) | 820 | 32.6% |
| **total** | 2516 | 100% |
| **C-written** | **1696** | **67.4%** |
<!-- STATUS:END -->
