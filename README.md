...
**C-written: 63.0% (1584 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1584/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1584 funcs, 63.0%)
- [x] 50% C-written (~1258 funcs) — DONE (1584 funcs, 63.0%)
- [ ] 75% C-written (~1887 funcs) (1584 so far)
...
| real-C (match pending) | 844 | 33.5% |
| asm shell (to do) | 932 | 37.0% |
| **total** | 2516 | 100% |
| **C-written** | **1584** | **63.0%** |
<!-- STATUS:END -->
