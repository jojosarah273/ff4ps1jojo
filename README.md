...
**C-written: 58.1% (1463 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1463/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1463 funcs, 58.1%)
- [x] 50% C-written (~1258 funcs) — DONE (1463 funcs, 58.1%)
- [ ] 75% C-written (~1887 funcs) (1463 so far)
...
| real-C (match pending) | 723 | 28.7% |
| asm shell (to do) | 1053 | 41.9% |
| **total** | 2516 | 100% |
| **C-written** | **1463** | **58.1%** |
<!-- STATUS:END -->
