...
**C-written: 56.0% (1410 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1410/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1410 funcs, 56.0%)
- [x] 50% C-written (~1258 funcs) — DONE (1410 funcs, 56.0%)
- [ ] 75% C-written (~1887 funcs) (1410 so far)
...
| real-C (match pending) | 670 | 26.6% |
| asm shell (to do) | 1106 | 44.0% |
| **total** | 2516 | 100% |
| **C-written** | **1410** | **56.0%** |
<!-- STATUS:END -->
