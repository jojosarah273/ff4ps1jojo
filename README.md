...
**C-written: 49.0% (1233 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1233/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1233 funcs, 49.0%)
- [ ] 50% C-written (~1258 funcs) (1233 so far)
- [ ] 75% C-written (~1887 funcs) (1233 so far)
...
| real-C (match pending) | 493 | 19.6% |
| asm shell (to do) | 1283 | 51.0% |
| **total** | 2516 | 100% |
| **C-written** | **1233** | **49.0%** |
<!-- STATUS:END -->
