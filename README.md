...
**C-written: 41.5% (1043 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1043/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1043 funcs, 41.5%)
- [ ] 50% C-written (~1258 funcs) (1043 so far)
- [ ] 75% C-written (~1887 funcs) (1043 so far)
...
| real-C (match pending) | 303 | 12.0% |
| asm shell (to do) | 1473 | 58.5% |
| **total** | 2516 | 100% |
| **C-written** | **1043** | **41.5%** |
<!-- STATUS:END -->
