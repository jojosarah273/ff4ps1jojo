...
**C-written: 71.0% (1787 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1787/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1787 funcs, 71.0%)
- [x] 50% C-written (~1258 funcs) — DONE (1787 funcs, 71.0%)
- [ ] 75% C-written (~1887 funcs) (1787 so far)
...
| real-C (match pending) | 1047 | 41.6% |
| asm shell (to do) | 729 | 29.0% |
| **total** | 2516 | 100% |
| **C-written** | **1787** | **71.0%** |
<!-- STATUS:END -->
