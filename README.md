...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (2516/2516 C-written, 780 byte-verified) |
...
| state | count | % |
|---|---|---|
| byte-verified (matched) | 780 | 31.0% |
| real-C (match pending) | 1736 | 69.0% |
