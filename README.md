...
**C-written: 82.2% (2068 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (2068/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (2068 funcs, 82.2%)
- [x] 50% C-written (~1258 funcs) — DONE (2068 funcs, 82.2%)
- [x] 75% C-written (~1887 funcs) — DONE (2068 funcs, 82.2%)
...
| real-C (match pending) | 1328 | 52.8% |
| asm shell (to do) | 448 | 17.8% |
| **total** | 2516 | 100% |
| **C-written** | **2068** | **82.2%** |
<!-- STATUS:END -->
