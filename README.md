...
**C-written: 65.4% (1646 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1646/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1646 funcs, 65.4%)
- [x] 50% C-written (~1258 funcs) — DONE (1646 funcs, 65.4%)
- [ ] 75% C-written (~1887 funcs) (1646 so far)
...
| real-C (match pending) | 906 | 36.0% |
| asm shell (to do) | 870 | 34.6% |
| **total** | 2516 | 100% |
| **C-written** | **1646** | **65.4%** |
<!-- STATUS:END -->
