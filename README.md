...
**C-written: 80.0% (2013 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (2013/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (2013 funcs, 80.0%)
- [x] 50% C-written (~1258 funcs) — DONE (2013 funcs, 80.0%)
- [x] 75% C-written (~1887 funcs) — DONE (2013 funcs, 80.0%)
...
| real-C (match pending) | 1273 | 50.6% |
| asm shell (to do) | 503 | 20.0% |
| **total** | 2516 | 100% |
| **C-written** | **2013** | **80.0%** |
<!-- STATUS:END -->
