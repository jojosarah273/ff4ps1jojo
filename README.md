...
**C-written: 69.8% (1756 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1756/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1756 funcs, 69.8%)
- [x] 50% C-written (~1258 funcs) — DONE (1756 funcs, 69.8%)
- [ ] 75% C-written (~1887 funcs) (1756 so far)
...
| real-C (match pending) | 1016 | 40.4% |
| asm shell (to do) | 760 | 30.2% |
| **total** | 2516 | 100% |
| **C-written** | **1756** | **69.8%** |
<!-- STATUS:END -->
