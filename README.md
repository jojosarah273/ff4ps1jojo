...
**C-written: 51.7% (1302 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1302/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1302 funcs, 51.7%)
- [x] 50% C-written (~1258 funcs) — DONE (1302 funcs, 51.7%)
- [ ] 75% C-written (~1887 funcs) (1302 so far)
...
| real-C (match pending) | 562 | 22.3% |
| asm shell (to do) | 1214 | 48.3% |
| **total** | 2516 | 100% |
| **C-written** | **1302** | **51.7%** |
<!-- STATUS:END -->
