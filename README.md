...
**C-written: 56.7% (1426 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1426/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1426 funcs, 56.7%)
- [x] 50% C-written (~1258 funcs) — DONE (1426 funcs, 56.7%)
- [ ] 75% C-written (~1887 funcs) (1426 so far)
...
| real-C (match pending) | 686 | 27.3% |
| asm shell (to do) | 1090 | 43.3% |
| **total** | 2516 | 100% |
| **C-written** | **1426** | **56.7%** |
<!-- STATUS:END -->
