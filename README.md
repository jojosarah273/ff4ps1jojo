...
**C-written: 53.7% (1350 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1350/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1350 funcs, 53.7%)
- [x] 50% C-written (~1258 funcs) — DONE (1350 funcs, 53.7%)
- [ ] 75% C-written (~1887 funcs) (1350 so far)
...
| real-C (match pending) | 610 | 24.2% |
| asm shell (to do) | 1166 | 46.3% |
| **total** | 2516 | 100% |
| **C-written** | **1350** | **53.7%** |
<!-- STATUS:END -->
