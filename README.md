...
**C-written: 57.8% (1453 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1453/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1453 funcs, 57.8%)
- [x] 50% C-written (~1258 funcs) — DONE (1453 funcs, 57.8%)
- [ ] 75% C-written (~1887 funcs) (1453 so far)
...
| real-C (match pending) | 713 | 28.3% |
| asm shell (to do) | 1063 | 42.2% |
| **total** | 2516 | 100% |
| **C-written** | **1453** | **57.8%** |
<!-- STATUS:END -->
