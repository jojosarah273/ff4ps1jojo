...
**C-written: 93.5% (2353 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (2353/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (2353 funcs, 93.5%)
- [x] 50% C-written (~1258 funcs) — DONE (2353 funcs, 93.5%)
- [x] 75% C-written (~1887 funcs) — DONE (2353 funcs, 93.5%)
...
| real-C (match pending) | 1613 | 64.1% |
| asm shell (to do) | 163 | 6.5% |
| **total** | 2516 | 100% |
| **C-written** | **2353** | **93.5%** |
<!-- STATUS:END -->
