...
**C-written: 62.2% (1565 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1565/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1565 funcs, 62.2%)
- [x] 50% C-written (~1258 funcs) — DONE (1565 funcs, 62.2%)
- [ ] 75% C-written (~1887 funcs) (1565 so far)
...
| real-C (match pending) | 825 | 32.8% |
| asm shell (to do) | 951 | 37.8% |
| **total** | 2516 | 100% |
| **C-written** | **1565** | **62.2%** |
<!-- STATUS:END -->
