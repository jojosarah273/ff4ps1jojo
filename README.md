...
**C-written: 54.5% (1370 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1370/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1370 funcs, 54.5%)
- [x] 50% C-written (~1258 funcs) — DONE (1370 funcs, 54.5%)
- [ ] 75% C-written (~1887 funcs) (1370 so far)
...
| real-C (match pending) | 630 | 25.0% |
| asm shell (to do) | 1146 | 45.5% |
| **total** | 2516 | 100% |
| **C-written** | **1370** | **54.5%** |
<!-- STATUS:END -->
