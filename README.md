...
**C-written: 60.3% (1516 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1516/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1516 funcs, 60.3%)
- [x] 50% C-written (~1258 funcs) — DONE (1516 funcs, 60.3%)
- [ ] 75% C-written (~1887 funcs) (1516 so far)
...
| real-C (match pending) | 776 | 30.8% |
| asm shell (to do) | 1000 | 39.7% |
| **total** | 2516 | 100% |
| **C-written** | **1516** | **60.3%** |
<!-- STATUS:END -->
