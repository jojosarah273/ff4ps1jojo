...
**C-written: 57.1% (1436 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1436/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1436 funcs, 57.1%)
- [x] 50% C-written (~1258 funcs) — DONE (1436 funcs, 57.1%)
- [ ] 75% C-written (~1887 funcs) (1436 so far)
...
| real-C (match pending) | 696 | 27.7% |
| asm shell (to do) | 1080 | 42.9% |
| **total** | 2516 | 100% |
| **C-written** | **1436** | **57.1%** |
<!-- STATUS:END -->
