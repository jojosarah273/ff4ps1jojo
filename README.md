...
**C-written: 55.9% (1406 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1406/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1406 funcs, 55.9%)
- [x] 50% C-written (~1258 funcs) — DONE (1406 funcs, 55.9%)
- [ ] 75% C-written (~1887 funcs) (1406 so far)
...
| real-C (match pending) | 666 | 26.5% |
| asm shell (to do) | 1110 | 44.1% |
| **total** | 2516 | 100% |
| **C-written** | **1406** | **55.9%** |
<!-- STATUS:END -->
