...
**C-written: 47.8% (1202 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1202/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1202 funcs, 47.8%)
- [ ] 50% C-written (~1258 funcs) (1202 so far)
- [ ] 75% C-written (~1887 funcs) (1202 so far)
...
| real-C (match pending) | 462 | 18.4% |
| asm shell (to do) | 1314 | 52.2% |
| **total** | 2516 | 100% |
| **C-written** | **1202** | **47.8%** |
<!-- STATUS:END -->
