...
**C-written: 59.9% (1508 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1508/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1508 funcs, 59.9%)
- [x] 50% C-written (~1258 funcs) — DONE (1508 funcs, 59.9%)
- [ ] 75% C-written (~1887 funcs) (1508 so far)
...
| real-C (match pending) | 768 | 30.5% |
| asm shell (to do) | 1008 | 40.1% |
| **total** | 2516 | 100% |
| **C-written** | **1508** | **59.9%** |
<!-- STATUS:END -->
