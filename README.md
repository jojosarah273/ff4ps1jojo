...
**C-written: 65.3% (1642 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1642/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1642 funcs, 65.3%)
- [x] 50% C-written (~1258 funcs) — DONE (1642 funcs, 65.3%)
- [ ] 75% C-written (~1887 funcs) (1642 so far)
...
| real-C (match pending) | 902 | 35.9% |
| asm shell (to do) | 874 | 34.7% |
| **total** | 2516 | 100% |
| **C-written** | **1642** | **65.3%** |
<!-- STATUS:END -->
