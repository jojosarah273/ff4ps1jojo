...
**C-written: 69.4% (1747 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1747/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1747 funcs, 69.4%)
- [x] 50% C-written (~1258 funcs) — DONE (1747 funcs, 69.4%)
- [ ] 75% C-written (~1887 funcs) (1747 so far)
...
| real-C (match pending) | 1007 | 40.0% |
| asm shell (to do) | 769 | 30.6% |
| **total** | 2516 | 100% |
| **C-written** | **1747** | **69.4%** |
<!-- STATUS:END -->
