...
**C-written: 65.9% (1658 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1658/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1658 funcs, 65.9%)
- [x] 50% C-written (~1258 funcs) — DONE (1658 funcs, 65.9%)
- [ ] 75% C-written (~1887 funcs) (1658 so far)
...
| real-C (match pending) | 918 | 36.5% |
| asm shell (to do) | 858 | 34.1% |
| **total** | 2516 | 100% |
| **C-written** | **1658** | **65.9%** |
<!-- STATUS:END -->
