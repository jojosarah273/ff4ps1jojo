...
**C-written: 70.9% (1784 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1784/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1784 funcs, 70.9%)
- [x] 50% C-written (~1258 funcs) — DONE (1784 funcs, 70.9%)
- [ ] 75% C-written (~1887 funcs) (1784 so far)
...
| real-C (match pending) | 1044 | 41.5% |
| asm shell (to do) | 732 | 29.1% |
| **total** | 2516 | 100% |
| **C-written** | **1784** | **70.9%** |
<!-- STATUS:END -->
