...
**C-written: 51.0% (1284 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1284/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1284 funcs, 51.0%)
- [x] 50% C-written (~1258 funcs) — DONE (1284 funcs, 51.0%)
- [ ] 75% C-written (~1887 funcs) (1284 so far)
...
| real-C (match pending) | 544 | 21.6% |
| asm shell (to do) | 1232 | 49.0% |
| **total** | 2516 | 100% |
| **C-written** | **1284** | **51.0%** |
<!-- STATUS:END -->
