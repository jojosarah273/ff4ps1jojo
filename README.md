...
**C-written: 94.6% (2381 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (2381/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (2381 funcs, 94.6%)
- [x] 50% C-written (~1258 funcs) — DONE (2381 funcs, 94.6%)
- [x] 75% C-written (~1887 funcs) — DONE (2381 funcs, 94.6%)
...
| real-C (match pending) | 1641 | 65.2% |
| asm shell (to do) | 135 | 5.4% |
| **total** | 2516 | 100% |
| **C-written** | **2381** | **94.6%** |
<!-- STATUS:END -->
