...
**C-written: 66.5% (1672 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1672/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1672 funcs, 66.5%)
- [x] 50% C-written (~1258 funcs) — DONE (1672 funcs, 66.5%)
- [ ] 75% C-written (~1887 funcs) (1672 so far)
...
| real-C (match pending) | 932 | 37.0% |
| asm shell (to do) | 844 | 33.5% |
| **total** | 2516 | 100% |
| **C-written** | **1672** | **66.5%** |
<!-- STATUS:END -->
