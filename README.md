...
**C-written: 73.8% (1857 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1857/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1857 funcs, 73.8%)
- [x] 50% C-written (~1258 funcs) — DONE (1857 funcs, 73.8%)
- [ ] 75% C-written (~1887 funcs) (1857 so far)
...
| real-C (match pending) | 1117 | 44.4% |
| asm shell (to do) | 659 | 26.2% |
| **total** | 2516 | 100% |
| **C-written** | **1857** | **73.8%** |
<!-- STATUS:END -->
