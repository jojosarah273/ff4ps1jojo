...
**C-written: 57.7% (1452 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1452/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1452 funcs, 57.7%)
- [x] 50% C-written (~1258 funcs) — DONE (1452 funcs, 57.7%)
- [ ] 75% C-written (~1887 funcs) (1452 so far)
...
| real-C (match pending) | 712 | 28.3% |
| asm shell (to do) | 1064 | 42.3% |
| **total** | 2516 | 100% |
| **C-written** | **1452** | **57.7%** |
<!-- STATUS:END -->
