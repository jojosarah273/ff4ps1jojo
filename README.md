...
**C-written: 51.2% (1288 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1288/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1288 funcs, 51.2%)
- [x] 50% C-written (~1258 funcs) — DONE (1288 funcs, 51.2%)
- [ ] 75% C-written (~1887 funcs) (1288 so far)
...
| real-C (match pending) | 548 | 21.8% |
| asm shell (to do) | 1228 | 48.8% |
| **total** | 2516 | 100% |
| **C-written** | **1288** | **51.2%** |
<!-- STATUS:END -->
