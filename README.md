...
**C-written: 57.6% (1448 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1448/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1448 funcs, 57.6%)
- [x] 50% C-written (~1258 funcs) — DONE (1448 funcs, 57.6%)
- [ ] 75% C-written (~1887 funcs) (1448 so far)
...
| real-C (match pending) | 708 | 28.1% |
| asm shell (to do) | 1068 | 42.4% |
| **total** | 2516 | 100% |
| **C-written** | **1448** | **57.6%** |
<!-- STATUS:END -->
