...
**C-written: 87.5% (2202 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (2202/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (2202 funcs, 87.5%)
- [x] 50% C-written (~1258 funcs) — DONE (2202 funcs, 87.5%)
- [x] 75% C-written (~1887 funcs) — DONE (2202 funcs, 87.5%)
...
| real-C (match pending) | 1462 | 58.1% |
| asm shell (to do) | 314 | 12.5% |
| **total** | 2516 | 100% |
| **C-written** | **2202** | **87.5%** |
<!-- STATUS:END -->
