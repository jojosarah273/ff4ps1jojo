...
**C-written: 51.6% (1299 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1299/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1299 funcs, 51.6%)
- [x] 50% C-written (~1258 funcs) — DONE (1299 funcs, 51.6%)
- [ ] 75% C-written (~1887 funcs) (1299 so far)
...
| real-C (match pending) | 559 | 22.2% |
| asm shell (to do) | 1217 | 48.4% |
| **total** | 2516 | 100% |
| **C-written** | **1299** | **51.6%** |
<!-- STATUS:END -->
