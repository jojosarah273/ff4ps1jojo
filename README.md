...
**C-written: 85.2% (2144 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (2144/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (2144 funcs, 85.2%)
- [x] 50% C-written (~1258 funcs) — DONE (2144 funcs, 85.2%)
- [x] 75% C-written (~1887 funcs) — DONE (2144 funcs, 85.2%)
...
| real-C (match pending) | 1404 | 55.8% |
| asm shell (to do) | 372 | 14.8% |
| **total** | 2516 | 100% |
| **C-written** | **2144** | **85.2%** |
<!-- STATUS:END -->
