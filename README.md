...
**C-written: 72.7% (1829 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1829/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1829 funcs, 72.7%)
- [x] 50% C-written (~1258 funcs) — DONE (1829 funcs, 72.7%)
- [ ] 75% C-written (~1887 funcs) (1829 so far)
...
| real-C (match pending) | 1089 | 43.3% |
| asm shell (to do) | 687 | 27.3% |
| **total** | 2516 | 100% |
| **C-written** | **1829** | **72.7%** |
<!-- STATUS:END -->
