...
**C-written: 51.4% (1294 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1294/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1294 funcs, 51.4%)
- [x] 50% C-written (~1258 funcs) — DONE (1294 funcs, 51.4%)
- [ ] 75% C-written (~1887 funcs) (1294 so far)
...
| real-C (match pending) | 554 | 22.0% |
| asm shell (to do) | 1222 | 48.6% |
| **total** | 2516 | 100% |
| **C-written** | **1294** | **51.4%** |
<!-- STATUS:END -->
