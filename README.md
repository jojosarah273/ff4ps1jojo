...
**C-written: 47.0% (1183 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1183/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1183 funcs, 47.0%)
- [ ] 50% C-written (~1258 funcs) (1183 so far)
- [ ] 75% C-written (~1887 funcs) (1183 so far)
...
| real-C (match pending) | 443 | 17.6% |
| asm shell (to do) | 1333 | 53.0% |
| **total** | 2516 | 100% |
| **C-written** | **1183** | **47.0%** |
<!-- STATUS:END -->
