...
**C-written: 61.4% (1546 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1546/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1546 funcs, 61.4%)
- [x] 50% C-written (~1258 funcs) — DONE (1546 funcs, 61.4%)
- [ ] 75% C-written (~1887 funcs) (1546 so far)
...
| real-C (match pending) | 806 | 32.0% |
| asm shell (to do) | 970 | 38.6% |
| **total** | 2516 | 100% |
| **C-written** | **1546** | **61.4%** |
<!-- STATUS:END -->
