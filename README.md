...
**C-written: 59.6% (1500 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1500/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1500 funcs, 59.6%)
- [x] 50% C-written (~1258 funcs) — DONE (1500 funcs, 59.6%)
- [ ] 75% C-written (~1887 funcs) (1500 so far)
...
| real-C (match pending) | 760 | 30.2% |
| asm shell (to do) | 1016 | 40.4% |
| **total** | 2516 | 100% |
| **C-written** | **1500** | **59.6%** |
<!-- STATUS:END -->
