...
**C-written: 60.2% (1514 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1514/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1514 funcs, 60.2%)
- [x] 50% C-written (~1258 funcs) — DONE (1514 funcs, 60.2%)
- [ ] 75% C-written (~1887 funcs) (1514 so far)
...
| real-C (match pending) | 774 | 30.8% |
| asm shell (to do) | 1002 | 39.8% |
| **total** | 2516 | 100% |
| **C-written** | **1514** | **60.2%** |
<!-- STATUS:END -->
