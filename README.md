...
**C-written: 59.4% (1494 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1494/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1494 funcs, 59.4%)
- [x] 50% C-written (~1258 funcs) — DONE (1494 funcs, 59.4%)
- [ ] 75% C-written (~1887 funcs) (1494 so far)
...
| real-C (match pending) | 754 | 30.0% |
| asm shell (to do) | 1022 | 40.6% |
| **total** | 2516 | 100% |
| **C-written** | **1494** | **59.4%** |
<!-- STATUS:END -->
