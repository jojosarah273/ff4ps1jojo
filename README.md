...
**C-written: 69.0% (1737 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1737/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1737 funcs, 69.0%)
- [x] 50% C-written (~1258 funcs) — DONE (1737 funcs, 69.0%)
- [ ] 75% C-written (~1887 funcs) (1737 so far)
...
| real-C (match pending) | 997 | 39.6% |
| asm shell (to do) | 779 | 31.0% |
| **total** | 2516 | 100% |
| **C-written** | **1737** | **69.0%** |
<!-- STATUS:END -->
