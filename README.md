...
**C-written: 61.6% (1549 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1549/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1549 funcs, 61.6%)
- [x] 50% C-written (~1258 funcs) — DONE (1549 funcs, 61.6%)
- [ ] 75% C-written (~1887 funcs) (1549 so far)
...
| real-C (match pending) | 809 | 32.2% |
| asm shell (to do) | 967 | 38.4% |
| **total** | 2516 | 100% |
| **C-written** | **1549** | **61.6%** |
<!-- STATUS:END -->
