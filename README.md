...
**C-written: 62.3% (1567 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1567/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1567 funcs, 62.3%)
- [x] 50% C-written (~1258 funcs) — DONE (1567 funcs, 62.3%)
- [ ] 75% C-written (~1887 funcs) (1567 so far)
...
| real-C (match pending) | 827 | 32.9% |
| asm shell (to do) | 949 | 37.7% |
| **total** | 2516 | 100% |
| **C-written** | **1567** | **62.3%** |
<!-- STATUS:END -->
