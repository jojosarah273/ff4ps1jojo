...
**C-written: 56.2% (1415 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1415/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1415 funcs, 56.2%)
- [x] 50% C-written (~1258 funcs) — DONE (1415 funcs, 56.2%)
- [ ] 75% C-written (~1887 funcs) (1415 so far)
...
| real-C (match pending) | 675 | 26.8% |
| asm shell (to do) | 1101 | 43.8% |
| **total** | 2516 | 100% |
| **C-written** | **1415** | **56.2%** |
<!-- STATUS:END -->
