...
**C-written: 68.6% (1725 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1725/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1725 funcs, 68.6%)
- [x] 50% C-written (~1258 funcs) — DONE (1725 funcs, 68.6%)
- [ ] 75% C-written (~1887 funcs) (1725 so far)
...
| real-C (match pending) | 985 | 39.1% |
| asm shell (to do) | 791 | 31.4% |
| **total** | 2516 | 100% |
| **C-written** | **1725** | **68.6%** |
<!-- STATUS:END -->
