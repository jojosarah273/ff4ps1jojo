...
**C-written: 55.7% (1401 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1401/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1401 funcs, 55.7%)
- [x] 50% C-written (~1258 funcs) — DONE (1401 funcs, 55.7%)
- [ ] 75% C-written (~1887 funcs) (1401 so far)
...
| real-C (match pending) | 661 | 26.3% |
| asm shell (to do) | 1115 | 44.3% |
| **total** | 2516 | 100% |
| **C-written** | **1401** | **55.7%** |
<!-- STATUS:END -->
