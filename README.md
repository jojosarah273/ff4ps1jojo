...
**C-written: 65.0% (1636 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1636/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1636 funcs, 65.0%)
- [x] 50% C-written (~1258 funcs) — DONE (1636 funcs, 65.0%)
- [ ] 75% C-written (~1887 funcs) (1636 so far)
...
| real-C (match pending) | 896 | 35.6% |
| asm shell (to do) | 880 | 35.0% |
| **total** | 2516 | 100% |
| **C-written** | **1636** | **65.0%** |
<!-- STATUS:END -->
