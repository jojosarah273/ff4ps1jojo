...
**C-written: 60.7% (1527 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1527/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1527 funcs, 60.7%)
- [x] 50% C-written (~1258 funcs) — DONE (1527 funcs, 60.7%)
- [ ] 75% C-written (~1887 funcs) (1527 so far)
...
| real-C (match pending) | 787 | 31.3% |
| asm shell (to do) | 989 | 39.3% |
| **total** | 2516 | 100% |
| **C-written** | **1527** | **60.7%** |
<!-- STATUS:END -->
