...
**C-written: 32.8% (826 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (826/2516 C-written, 739 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (826 funcs, 32.8%)
- [ ] 50% C-written (~1258 funcs) (826 so far)
- [ ] 75% C-written (~1887 funcs) (826 so far)
...
| real-C (match pending) | 87 | 3.5% |
| asm shell (to do) | 1690 | 67.2% |
| **total** | 2516 | 100% |
| **C-written** | **826** | **32.8%** |
<!-- STATUS:END -->
