...
**C-written: 67.1% (1688 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1688/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1688 funcs, 67.1%)
- [x] 50% C-written (~1258 funcs) — DONE (1688 funcs, 67.1%)
- [ ] 75% C-written (~1887 funcs) (1688 so far)
...
| real-C (match pending) | 948 | 37.7% |
| asm shell (to do) | 828 | 32.9% |
| **total** | 2516 | 100% |
| **C-written** | **1688** | **67.1%** |
<!-- STATUS:END -->
