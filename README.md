...
**C-written: 56.9% (1431 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1431/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1431 funcs, 56.9%)
- [x] 50% C-written (~1258 funcs) — DONE (1431 funcs, 56.9%)
- [ ] 75% C-written (~1887 funcs) (1431 so far)
...
| real-C (match pending) | 691 | 27.5% |
| asm shell (to do) | 1085 | 43.1% |
| **total** | 2516 | 100% |
| **C-written** | **1431** | **56.9%** |
<!-- STATUS:END -->
