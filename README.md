...
**C-written: 55.0% (1385 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1385/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1385 funcs, 55.0%)
- [x] 50% C-written (~1258 funcs) — DONE (1385 funcs, 55.0%)
- [ ] 75% C-written (~1887 funcs) (1385 so far)
...
| real-C (match pending) | 645 | 25.6% |
| asm shell (to do) | 1131 | 45.0% |
| **total** | 2516 | 100% |
| **C-written** | **1385** | **55.0%** |
<!-- STATUS:END -->
