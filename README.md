...
**C-written: 70.0% (1760 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1760/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1760 funcs, 70.0%)
- [x] 50% C-written (~1258 funcs) — DONE (1760 funcs, 70.0%)
- [ ] 75% C-written (~1887 funcs) (1760 so far)
...
| real-C (match pending) | 1020 | 40.5% |
| asm shell (to do) | 756 | 30.0% |
| **total** | 2516 | 100% |
| **C-written** | **1760** | **70.0%** |
<!-- STATUS:END -->
