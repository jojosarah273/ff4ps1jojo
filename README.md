...
**C-written: 59.4% (1495 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1495/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1495 funcs, 59.4%)
- [x] 50% C-written (~1258 funcs) — DONE (1495 funcs, 59.4%)
- [ ] 75% C-written (~1887 funcs) (1495 so far)
...
| real-C (match pending) | 755 | 30.0% |
| asm shell (to do) | 1021 | 40.6% |
| **total** | 2516 | 100% |
| **C-written** | **1495** | **59.4%** |
<!-- STATUS:END -->
