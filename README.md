...
**C-written: 65.8% (1656 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1656/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1656 funcs, 65.8%)
- [x] 50% C-written (~1258 funcs) — DONE (1656 funcs, 65.8%)
- [ ] 75% C-written (~1887 funcs) (1656 so far)
...
| real-C (match pending) | 916 | 36.4% |
| asm shell (to do) | 860 | 34.2% |
| **total** | 2516 | 100% |
| **C-written** | **1656** | **65.8%** |
<!-- STATUS:END -->
