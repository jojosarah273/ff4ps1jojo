...
**C-written: 74.6% (1878 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1878/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1878 funcs, 74.6%)
- [x] 50% C-written (~1258 funcs) — DONE (1878 funcs, 74.6%)
- [ ] 75% C-written (~1887 funcs) (1878 so far)
...
| real-C (match pending) | 1138 | 45.2% |
| asm shell (to do) | 638 | 25.4% |
| **total** | 2516 | 100% |
| **C-written** | **1878** | **74.6%** |
<!-- STATUS:END -->
