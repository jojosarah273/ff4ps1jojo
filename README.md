...
**C-written: 59.5% (1497 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1497/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1497 funcs, 59.5%)
- [x] 50% C-written (~1258 funcs) — DONE (1497 funcs, 59.5%)
- [ ] 75% C-written (~1887 funcs) (1497 so far)
...
| real-C (match pending) | 757 | 30.1% |
| asm shell (to do) | 1019 | 40.5% |
| **total** | 2516 | 100% |
| **C-written** | **1497** | **59.5%** |
<!-- STATUS:END -->
