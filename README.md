...
**C-written: 70.0% (1761 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1761/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1761 funcs, 70.0%)
- [x] 50% C-written (~1258 funcs) — DONE (1761 funcs, 70.0%)
- [ ] 75% C-written (~1887 funcs) (1761 so far)
...
| real-C (match pending) | 1021 | 40.6% |
| asm shell (to do) | 755 | 30.0% |
| **total** | 2516 | 100% |
| **C-written** | **1761** | **70.0%** |
<!-- STATUS:END -->
