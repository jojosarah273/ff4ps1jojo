...
**C-written: 67.7% (1703 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1703/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1703 funcs, 67.7%)
- [x] 50% C-written (~1258 funcs) — DONE (1703 funcs, 67.7%)
- [ ] 75% C-written (~1887 funcs) (1703 so far)
...
| real-C (match pending) | 963 | 38.3% |
| asm shell (to do) | 813 | 32.3% |
| **total** | 2516 | 100% |
| **C-written** | **1703** | **67.7%** |
<!-- STATUS:END -->
