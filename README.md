...
**C-written: 70.8% (1781 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1781/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1781 funcs, 70.8%)
- [x] 50% C-written (~1258 funcs) — DONE (1781 funcs, 70.8%)
- [ ] 75% C-written (~1887 funcs) (1781 so far)
...
| real-C (match pending) | 1041 | 41.4% |
| asm shell (to do) | 735 | 29.2% |
| **total** | 2516 | 100% |
| **C-written** | **1781** | **70.8%** |
<!-- STATUS:END -->
