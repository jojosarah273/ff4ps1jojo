...
**C-written: 58.4% (1469 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1469/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1469 funcs, 58.4%)
- [x] 50% C-written (~1258 funcs) — DONE (1469 funcs, 58.4%)
- [ ] 75% C-written (~1887 funcs) (1469 so far)
...
| real-C (match pending) | 729 | 29.0% |
| asm shell (to do) | 1047 | 41.6% |
| **total** | 2516 | 100% |
| **C-written** | **1469** | **58.4%** |
<!-- STATUS:END -->
