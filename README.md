...
**C-written: 55.2% (1389 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1389/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1389 funcs, 55.2%)
- [x] 50% C-written (~1258 funcs) — DONE (1389 funcs, 55.2%)
- [ ] 75% C-written (~1887 funcs) (1389 so far)
...
| real-C (match pending) | 649 | 25.8% |
| asm shell (to do) | 1127 | 44.8% |
| **total** | 2516 | 100% |
| **C-written** | **1389** | **55.2%** |
<!-- STATUS:END -->
