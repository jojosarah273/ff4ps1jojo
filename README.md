...
**C-written: 55.6% (1400 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1400/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1400 funcs, 55.6%)
- [x] 50% C-written (~1258 funcs) — DONE (1400 funcs, 55.6%)
- [ ] 75% C-written (~1887 funcs) (1400 so far)
...
| real-C (match pending) | 660 | 26.2% |
| asm shell (to do) | 1116 | 44.4% |
| **total** | 2516 | 100% |
| **C-written** | **1400** | **55.6%** |
<!-- STATUS:END -->
