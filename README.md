...
**C-written: 53.5% (1345 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1345/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1345 funcs, 53.5%)
- [x] 50% C-written (~1258 funcs) — DONE (1345 funcs, 53.5%)
- [ ] 75% C-written (~1887 funcs) (1345 so far)
...
| real-C (match pending) | 605 | 24.0% |
| asm shell (to do) | 1171 | 46.5% |
| **total** | 2516 | 100% |
| **C-written** | **1345** | **53.5%** |
<!-- STATUS:END -->
