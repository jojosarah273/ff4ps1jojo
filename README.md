...
**C-written: 69.3% (1743 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1743/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1743 funcs, 69.3%)
- [x] 50% C-written (~1258 funcs) — DONE (1743 funcs, 69.3%)
- [ ] 75% C-written (~1887 funcs) (1743 so far)
...
| real-C (match pending) | 1003 | 39.9% |
| asm shell (to do) | 773 | 30.7% |
| **total** | 2516 | 100% |
| **C-written** | **1743** | **69.3%** |
<!-- STATUS:END -->
