...
**C-written: 97.6% (2455 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (2455/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (2455 funcs, 97.6%)
- [x] 50% C-written (~1258 funcs) — DONE (2455 funcs, 97.6%)
- [x] 75% C-written (~1887 funcs) — DONE (2455 funcs, 97.6%)
...
| real-C (match pending) | 1715 | 68.2% |
| asm shell (to do) | 61 | 2.4% |
| **total** | 2516 | 100% |
| **C-written** | **2455** | **97.6%** |
<!-- STATUS:END -->
