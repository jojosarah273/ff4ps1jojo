...
**C-written: 53.1% (1335 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1335/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1335 funcs, 53.1%)
- [x] 50% C-written (~1258 funcs) — DONE (1335 funcs, 53.1%)
- [ ] 75% C-written (~1887 funcs) (1335 so far)
...
| real-C (match pending) | 595 | 23.6% |
| asm shell (to do) | 1181 | 46.9% |
| **total** | 2516 | 100% |
| **C-written** | **1335** | **53.1%** |
<!-- STATUS:END -->
