...
**C-written: 57.5% (1446 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1446/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1446 funcs, 57.5%)
- [x] 50% C-written (~1258 funcs) — DONE (1446 funcs, 57.5%)
- [ ] 75% C-written (~1887 funcs) (1446 so far)
...
| real-C (match pending) | 706 | 28.1% |
| asm shell (to do) | 1070 | 42.5% |
| **total** | 2516 | 100% |
| **C-written** | **1446** | **57.5%** |
<!-- STATUS:END -->
