...
**C-written: 48.9% (1231 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1231/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1231 funcs, 48.9%)
- [ ] 50% C-written (~1258 funcs) (1231 so far)
- [ ] 75% C-written (~1887 funcs) (1231 so far)
...
| real-C (match pending) | 491 | 19.5% |
| asm shell (to do) | 1285 | 51.1% |
| **total** | 2516 | 100% |
| **C-written** | **1231** | **48.9%** |
<!-- STATUS:END -->
