...
**C-written: 66.1% (1663 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1663/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1663 funcs, 66.1%)
- [x] 50% C-written (~1258 funcs) — DONE (1663 funcs, 66.1%)
- [ ] 75% C-written (~1887 funcs) (1663 so far)
...
| real-C (match pending) | 923 | 36.7% |
| asm shell (to do) | 853 | 33.9% |
| **total** | 2516 | 100% |
| **C-written** | **1663** | **66.1%** |
<!-- STATUS:END -->
