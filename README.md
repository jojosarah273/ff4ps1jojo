...
**C-written: 63.5% (1597 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1597/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1597 funcs, 63.5%)
- [x] 50% C-written (~1258 funcs) — DONE (1597 funcs, 63.5%)
- [ ] 75% C-written (~1887 funcs) (1597 so far)
...
| real-C (match pending) | 857 | 34.1% |
| asm shell (to do) | 919 | 36.5% |
| **total** | 2516 | 100% |
| **C-written** | **1597** | **63.5%** |
<!-- STATUS:END -->
