...
**C-written: 86.4% (2175 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (2175/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (2175 funcs, 86.4%)
- [x] 50% C-written (~1258 funcs) — DONE (2175 funcs, 86.4%)
- [x] 75% C-written (~1887 funcs) — DONE (2175 funcs, 86.4%)
...
| real-C (match pending) | 1435 | 57.0% |
| asm shell (to do) | 341 | 13.6% |
| **total** | 2516 | 100% |
| **C-written** | **2175** | **86.4%** |
<!-- STATUS:END -->
