...
**C-written: 48.3% (1215 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1215/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1215 funcs, 48.3%)
- [ ] 50% C-written (~1258 funcs) (1215 so far)
- [ ] 75% C-written (~1887 funcs) (1215 so far)
...
| real-C (match pending) | 475 | 18.9% |
| asm shell (to do) | 1301 | 51.7% |
| **total** | 2516 | 100% |
| **C-written** | **1215** | **48.3%** |
<!-- STATUS:END -->
