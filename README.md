...
**C-written: 60.6% (1524 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1524/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1524 funcs, 60.6%)
- [x] 50% C-written (~1258 funcs) — DONE (1524 funcs, 60.6%)
- [ ] 75% C-written (~1887 funcs) (1524 so far)
...
| real-C (match pending) | 784 | 31.2% |
| asm shell (to do) | 992 | 39.4% |
| **total** | 2516 | 100% |
| **C-written** | **1524** | **60.6%** |
<!-- STATUS:END -->
