...
**C-written: 80.8% (2032 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (2032/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (2032 funcs, 80.8%)
- [x] 50% C-written (~1258 funcs) — DONE (2032 funcs, 80.8%)
- [x] 75% C-written (~1887 funcs) — DONE (2032 funcs, 80.8%)
...
| real-C (match pending) | 1292 | 51.4% |
| asm shell (to do) | 484 | 19.2% |
| **total** | 2516 | 100% |
| **C-written** | **2032** | **80.8%** |
<!-- STATUS:END -->
