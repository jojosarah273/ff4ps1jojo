...
**C-written: 75.8% (1906 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1906/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1906 funcs, 75.8%)
- [x] 50% C-written (~1258 funcs) — DONE (1906 funcs, 75.8%)
- [x] 75% C-written (~1887 funcs) — DONE (1906 funcs, 75.8%)
...
| real-C (match pending) | 1166 | 46.3% |
| asm shell (to do) | 610 | 24.2% |
| **total** | 2516 | 100% |
| **C-written** | **1906** | **75.8%** |
<!-- STATUS:END -->
