...
**C-written: 56.4% (1420 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1420/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1420 funcs, 56.4%)
- [x] 50% C-written (~1258 funcs) — DONE (1420 funcs, 56.4%)
- [ ] 75% C-written (~1887 funcs) (1420 so far)
...
| real-C (match pending) | 680 | 27.0% |
| asm shell (to do) | 1096 | 43.6% |
| **total** | 2516 | 100% |
| **C-written** | **1420** | **56.4%** |
<!-- STATUS:END -->
