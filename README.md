...
**C-written: 60.3% (1517 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1517/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1517 funcs, 60.3%)
- [x] 50% C-written (~1258 funcs) — DONE (1517 funcs, 60.3%)
- [ ] 75% C-written (~1887 funcs) (1517 so far)
...
| real-C (match pending) | 777 | 30.9% |
| asm shell (to do) | 999 | 39.7% |
| **total** | 2516 | 100% |
| **C-written** | **1517** | **60.3%** |
<!-- STATUS:END -->
