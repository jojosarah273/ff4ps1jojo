...
**C-written: 56.6% (1423 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1423/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1423 funcs, 56.6%)
- [x] 50% C-written (~1258 funcs) — DONE (1423 funcs, 56.6%)
- [ ] 75% C-written (~1887 funcs) (1423 so far)
...
| real-C (match pending) | 683 | 27.1% |
| asm shell (to do) | 1093 | 43.4% |
| **total** | 2516 | 100% |
| **C-written** | **1423** | **56.6%** |
<!-- STATUS:END -->
