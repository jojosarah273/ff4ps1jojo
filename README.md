...
**C-written: 53.9% (1355 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1355/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1355 funcs, 53.9%)
- [x] 50% C-written (~1258 funcs) — DONE (1355 funcs, 53.9%)
- [ ] 75% C-written (~1887 funcs) (1355 so far)
...
| real-C (match pending) | 615 | 24.4% |
| asm shell (to do) | 1161 | 46.1% |
| **total** | 2516 | 100% |
| **C-written** | **1355** | **53.9%** |
<!-- STATUS:END -->
