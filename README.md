...
**C-written: 83.5% (2102 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (2102/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (2102 funcs, 83.5%)
- [x] 50% C-written (~1258 funcs) — DONE (2102 funcs, 83.5%)
- [x] 75% C-written (~1887 funcs) — DONE (2102 funcs, 83.5%)
...
| real-C (match pending) | 1362 | 54.1% |
| asm shell (to do) | 414 | 16.5% |
| **total** | 2516 | 100% |
| **C-written** | **2102** | **83.5%** |
<!-- STATUS:END -->
