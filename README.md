...
**C-written: 58.8% (1479 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1479/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1479 funcs, 58.8%)
- [x] 50% C-written (~1258 funcs) — DONE (1479 funcs, 58.8%)
- [ ] 75% C-written (~1887 funcs) (1479 so far)
...
| real-C (match pending) | 739 | 29.4% |
| asm shell (to do) | 1037 | 41.2% |
| **total** | 2516 | 100% |
| **C-written** | **1479** | **58.8%** |
<!-- STATUS:END -->
