...
**C-written: 48.6% (1224 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1224/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1224 funcs, 48.6%)
- [ ] 50% C-written (~1258 funcs) (1224 so far)
- [ ] 75% C-written (~1887 funcs) (1224 so far)
...
| real-C (match pending) | 484 | 19.2% |
| asm shell (to do) | 1292 | 51.4% |
| **total** | 2516 | 100% |
| **C-written** | **1224** | **48.6%** |
<!-- STATUS:END -->
