...
**C-written: 61.1% (1538 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1538/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1538 funcs, 61.1%)
- [x] 50% C-written (~1258 funcs) — DONE (1538 funcs, 61.1%)
- [ ] 75% C-written (~1887 funcs) (1538 so far)
...
| real-C (match pending) | 798 | 31.7% |
| asm shell (to do) | 978 | 38.9% |
| **total** | 2516 | 100% |
| **C-written** | **1538** | **61.1%** |
<!-- STATUS:END -->
