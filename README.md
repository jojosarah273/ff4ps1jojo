...
**C-written: 33.1% (833 funcs) — the Phase A mission is the rest.**
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (833 funcs, 33.1%)
- [ ] 50% C-written (~1258 funcs) (833 so far)
- [ ] 75% C-written (~1887 funcs) (833 so far)
