...
**C-written: 89.3% (2248 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (2248/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (2248 funcs, 89.3%)
- [x] 50% C-written (~1258 funcs) — DONE (2248 funcs, 89.3%)
- [x] 75% C-written (~1887 funcs) — DONE (2248 funcs, 89.3%)
...
| real-C (match pending) | 1508 | 59.9% |
| asm shell (to do) | 268 | 10.7% |
| **total** | 2516 | 100% |
| **C-written** | **2248** | **89.3%** |
<!-- STATUS:END -->
