...
**C-written: 76.0% (1911 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1911/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1911 funcs, 76.0%)
- [x] 50% C-written (~1258 funcs) — DONE (1911 funcs, 76.0%)
- [x] 75% C-written (~1887 funcs) — DONE (1911 funcs, 76.0%)
...
| real-C (match pending) | 1171 | 46.5% |
| asm shell (to do) | 605 | 24.0% |
| **total** | 2516 | 100% |
| **C-written** | **1911** | **76.0%** |
<!-- STATUS:END -->
