...
**C-written: 63.8% (1606 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1606/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1606 funcs, 63.8%)
- [x] 50% C-written (~1258 funcs) — DONE (1606 funcs, 63.8%)
- [ ] 75% C-written (~1887 funcs) (1606 so far)
...
| real-C (match pending) | 866 | 34.4% |
| asm shell (to do) | 910 | 36.2% |
| **total** | 2516 | 100% |
| **C-written** | **1606** | **63.8%** |
<!-- STATUS:END -->
