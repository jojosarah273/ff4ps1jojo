...
**C-written: 54.2% (1363 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1363/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1363 funcs, 54.2%)
- [x] 50% C-written (~1258 funcs) — DONE (1363 funcs, 54.2%)
- [ ] 75% C-written (~1887 funcs) (1363 so far)
...
| real-C (match pending) | 623 | 24.8% |
| asm shell (to do) | 1153 | 45.8% |
| **total** | 2516 | 100% |
| **C-written** | **1363** | **54.2%** |
<!-- STATUS:END -->
