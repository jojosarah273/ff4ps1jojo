...
**C-written: 99.5% (2503 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (2503/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (2503 funcs, 99.5%)
- [x] 50% C-written (~1258 funcs) — DONE (2503 funcs, 99.5%)
- [x] 75% C-written (~1887 funcs) — DONE (2503 funcs, 99.5%)
...
| real-C (match pending) | 1763 | 70.1% |
| asm shell (to do) | 12 | 0.5% |
| **total** | 2515 | 100% |
| **C-written** | **2503** | **99.5%** |
<!-- STATUS:END -->
