...
**C-written: 60.5% (1521 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1521/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1521 funcs, 60.5%)
- [x] 50% C-written (~1258 funcs) — DONE (1521 funcs, 60.5%)
- [ ] 75% C-written (~1887 funcs) (1521 so far)
...
| real-C (match pending) | 781 | 31.0% |
| asm shell (to do) | 995 | 39.5% |
| **total** | 2516 | 100% |
| **C-written** | **1521** | **60.5%** |
<!-- STATUS:END -->
