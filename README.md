...
**C-written: 56.6% (1425 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1425/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1425 funcs, 56.6%)
- [x] 50% C-written (~1258 funcs) — DONE (1425 funcs, 56.6%)
- [ ] 75% C-written (~1887 funcs) (1425 so far)
...
| real-C (match pending) | 685 | 27.2% |
| asm shell (to do) | 1091 | 43.4% |
| **total** | 2516 | 100% |
| **C-written** | **1425** | **56.6%** |
<!-- STATUS:END -->
