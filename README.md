...
**C-written: 63.2% (1591 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1591/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1591 funcs, 63.2%)
- [x] 50% C-written (~1258 funcs) — DONE (1591 funcs, 63.2%)
- [ ] 75% C-written (~1887 funcs) (1591 so far)
...
| real-C (match pending) | 851 | 33.8% |
| asm shell (to do) | 925 | 36.8% |
| **total** | 2516 | 100% |
| **C-written** | **1591** | **63.2%** |
<!-- STATUS:END -->
