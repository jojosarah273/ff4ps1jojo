...
**C-written: 59.0% (1485 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1485/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1485 funcs, 59.0%)
- [x] 50% C-written (~1258 funcs) — DONE (1485 funcs, 59.0%)
- [ ] 75% C-written (~1887 funcs) (1485 so far)
...
| real-C (match pending) | 745 | 29.6% |
| asm shell (to do) | 1031 | 41.0% |
| **total** | 2516 | 100% |
| **C-written** | **1485** | **59.0%** |
<!-- STATUS:END -->
