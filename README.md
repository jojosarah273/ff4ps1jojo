...
**C-written: 73.6% (1852 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1852/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1852 funcs, 73.6%)
- [x] 50% C-written (~1258 funcs) — DONE (1852 funcs, 73.6%)
- [ ] 75% C-written (~1887 funcs) (1852 so far)
...
| real-C (match pending) | 1112 | 44.2% |
| asm shell (to do) | 664 | 26.4% |
| **total** | 2516 | 100% |
| **C-written** | **1852** | **73.6%** |
<!-- STATUS:END -->
