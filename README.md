...
**C-written: 54.3% (1367 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1367/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1367 funcs, 54.3%)
- [x] 50% C-written (~1258 funcs) — DONE (1367 funcs, 54.3%)
- [ ] 75% C-written (~1887 funcs) (1367 so far)
...
| real-C (match pending) | 627 | 24.9% |
| asm shell (to do) | 1149 | 45.7% |
| **total** | 2516 | 100% |
| **C-written** | **1367** | **54.3%** |
<!-- STATUS:END -->
