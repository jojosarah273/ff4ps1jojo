...
**C-written: 71.9% (1808 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1808/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1808 funcs, 71.9%)
- [x] 50% C-written (~1258 funcs) — DONE (1808 funcs, 71.9%)
- [ ] 75% C-written (~1887 funcs) (1808 so far)
...
| real-C (match pending) | 1068 | 42.4% |
| asm shell (to do) | 708 | 28.1% |
| **total** | 2516 | 100% |
| **C-written** | **1808** | **71.9%** |
<!-- STATUS:END -->
