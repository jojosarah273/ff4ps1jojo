...
**C-written: 54.9% (1381 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1381/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1381 funcs, 54.9%)
- [x] 50% C-written (~1258 funcs) — DONE (1381 funcs, 54.9%)
- [ ] 75% C-written (~1887 funcs) (1381 so far)
...
| real-C (match pending) | 641 | 25.5% |
| asm shell (to do) | 1135 | 45.1% |
| **total** | 2516 | 100% |
| **C-written** | **1381** | **54.9%** |
<!-- STATUS:END -->
