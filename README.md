...
**C-written: 59.8% (1504 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1504/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1504 funcs, 59.8%)
- [x] 50% C-written (~1258 funcs) — DONE (1504 funcs, 59.8%)
- [ ] 75% C-written (~1887 funcs) (1504 so far)
...
| real-C (match pending) | 764 | 30.4% |
| asm shell (to do) | 1012 | 40.2% |
| **total** | 2516 | 100% |
| **C-written** | **1504** | **59.8%** |
<!-- STATUS:END -->
