...
**C-written: 60.7% (1526 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1526/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1526 funcs, 60.7%)
- [x] 50% C-written (~1258 funcs) — DONE (1526 funcs, 60.7%)
- [ ] 75% C-written (~1887 funcs) (1526 so far)
...
| real-C (match pending) | 786 | 31.2% |
| asm shell (to do) | 990 | 39.3% |
| **total** | 2516 | 100% |
| **C-written** | **1526** | **60.7%** |
<!-- STATUS:END -->
