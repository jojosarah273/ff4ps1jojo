...
**C-written: 56.6% (1424 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1424/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1424 funcs, 56.6%)
- [x] 50% C-written (~1258 funcs) — DONE (1424 funcs, 56.6%)
- [ ] 75% C-written (~1887 funcs) (1424 so far)
...
| real-C (match pending) | 684 | 27.2% |
| asm shell (to do) | 1092 | 43.4% |
| **total** | 2516 | 100% |
| **C-written** | **1424** | **56.6%** |
<!-- STATUS:END -->
