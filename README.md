...
**C-written: 66.9% (1683 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1683/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1683 funcs, 66.9%)
- [x] 50% C-written (~1258 funcs) — DONE (1683 funcs, 66.9%)
- [ ] 75% C-written (~1887 funcs) (1683 so far)
...
| real-C (match pending) | 943 | 37.5% |
| asm shell (to do) | 833 | 33.1% |
| **total** | 2516 | 100% |
| **C-written** | **1683** | **66.9%** |
<!-- STATUS:END -->
