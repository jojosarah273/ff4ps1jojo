...
**C-written: 58.7% (1477 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1477/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1477 funcs, 58.7%)
- [x] 50% C-written (~1258 funcs) — DONE (1477 funcs, 58.7%)
- [ ] 75% C-written (~1887 funcs) (1477 so far)
...
| real-C (match pending) | 737 | 29.3% |
| asm shell (to do) | 1039 | 41.3% |
| **total** | 2516 | 100% |
| **C-written** | **1477** | **58.7%** |
<!-- STATUS:END -->
