...
**C-written: 82.8% (2083 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (2083/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (2083 funcs, 82.8%)
- [x] 50% C-written (~1258 funcs) — DONE (2083 funcs, 82.8%)
- [x] 75% C-written (~1887 funcs) — DONE (2083 funcs, 82.8%)
...
| real-C (match pending) | 1343 | 53.4% |
| asm shell (to do) | 433 | 17.2% |
| **total** | 2516 | 100% |
| **C-written** | **2083** | **82.8%** |
<!-- STATUS:END -->
