...
**C-written: 58.6% (1474 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1474/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1474 funcs, 58.6%)
- [x] 50% C-written (~1258 funcs) — DONE (1474 funcs, 58.6%)
- [ ] 75% C-written (~1887 funcs) (1474 so far)
...
| real-C (match pending) | 734 | 29.2% |
| asm shell (to do) | 1042 | 41.4% |
| **total** | 2516 | 100% |
| **C-written** | **1474** | **58.6%** |
<!-- STATUS:END -->
