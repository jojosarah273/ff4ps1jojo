...
**C-written: 78.0% (1962 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1962/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1962 funcs, 78.0%)
- [x] 50% C-written (~1258 funcs) — DONE (1962 funcs, 78.0%)
- [x] 75% C-written (~1887 funcs) — DONE (1962 funcs, 78.0%)
...
| real-C (match pending) | 1222 | 48.6% |
| asm shell (to do) | 554 | 22.0% |
| **total** | 2516 | 100% |
| **C-written** | **1962** | **78.0%** |
<!-- STATUS:END -->
