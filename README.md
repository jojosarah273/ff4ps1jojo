...
**C-written: 59.9% (1506 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1506/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1506 funcs, 59.9%)
- [x] 50% C-written (~1258 funcs) — DONE (1506 funcs, 59.9%)
- [ ] 75% C-written (~1887 funcs) (1506 so far)
...
| real-C (match pending) | 766 | 30.4% |
| asm shell (to do) | 1010 | 40.1% |
| **total** | 2516 | 100% |
| **C-written** | **1506** | **59.9%** |
<!-- STATUS:END -->
