...
**C-written: 52.3% (1315 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1315/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1315 funcs, 52.3%)
- [x] 50% C-written (~1258 funcs) — DONE (1315 funcs, 52.3%)
- [ ] 75% C-written (~1887 funcs) (1315 so far)
...
| real-C (match pending) | 575 | 22.9% |
| asm shell (to do) | 1201 | 47.7% |
| **total** | 2516 | 100% |
| **C-written** | **1315** | **52.3%** |
<!-- STATUS:END -->
