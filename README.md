...
**C-written: 73.0% (1837 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1837/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1837 funcs, 73.0%)
- [x] 50% C-written (~1258 funcs) — DONE (1837 funcs, 73.0%)
- [ ] 75% C-written (~1887 funcs) (1837 so far)
...
| real-C (match pending) | 1097 | 43.6% |
| asm shell (to do) | 679 | 27.0% |
| **total** | 2516 | 100% |
| **C-written** | **1837** | **73.0%** |
<!-- STATUS:END -->
