...
**C-written: 61.0% (1534 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1534/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1534 funcs, 61.0%)
- [x] 50% C-written (~1258 funcs) — DONE (1534 funcs, 61.0%)
- [ ] 75% C-written (~1887 funcs) (1534 so far)
...
| real-C (match pending) | 794 | 31.6% |
| asm shell (to do) | 982 | 39.0% |
| **total** | 2516 | 100% |
| **C-written** | **1534** | **61.0%** |
<!-- STATUS:END -->
