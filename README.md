...
**C-written: 57.0% (1433 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1433/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1433 funcs, 57.0%)
- [x] 50% C-written (~1258 funcs) — DONE (1433 funcs, 57.0%)
- [ ] 75% C-written (~1887 funcs) (1433 so far)
...
| real-C (match pending) | 693 | 27.5% |
| asm shell (to do) | 1083 | 43.0% |
| **total** | 2516 | 100% |
| **C-written** | **1433** | **57.0%** |
<!-- STATUS:END -->
