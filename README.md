...
**C-written: 56.3% (1416 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1416/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1416 funcs, 56.3%)
- [x] 50% C-written (~1258 funcs) — DONE (1416 funcs, 56.3%)
- [ ] 75% C-written (~1887 funcs) (1416 so far)
...
| real-C (match pending) | 676 | 26.9% |
| asm shell (to do) | 1100 | 43.7% |
| **total** | 2516 | 100% |
| **C-written** | **1416** | **56.3%** |
<!-- STATUS:END -->
