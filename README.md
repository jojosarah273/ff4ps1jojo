...
**C-written: 71.7% (1803 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1803/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1803 funcs, 71.7%)
- [x] 50% C-written (~1258 funcs) — DONE (1803 funcs, 71.7%)
- [ ] 75% C-written (~1887 funcs) (1803 so far)
...
| real-C (match pending) | 1063 | 42.2% |
| asm shell (to do) | 713 | 28.3% |
| **total** | 2516 | 100% |
| **C-written** | **1803** | **71.7%** |
<!-- STATUS:END -->
