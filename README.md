...
**C-written: 91.1% (2291 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (2291/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (2291 funcs, 91.1%)
- [x] 50% C-written (~1258 funcs) — DONE (2291 funcs, 91.1%)
- [x] 75% C-written (~1887 funcs) — DONE (2291 funcs, 91.1%)
...
| real-C (match pending) | 1551 | 61.6% |
| asm shell (to do) | 225 | 8.9% |
| **total** | 2516 | 100% |
| **C-written** | **2291** | **91.1%** |
<!-- STATUS:END -->
