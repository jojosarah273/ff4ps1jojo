...
**C-written: 70.2% (1765 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1765/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1765 funcs, 70.2%)
- [x] 50% C-written (~1258 funcs) — DONE (1765 funcs, 70.2%)
- [ ] 75% C-written (~1887 funcs) (1765 so far)
...
| real-C (match pending) | 1025 | 40.7% |
| asm shell (to do) | 751 | 29.8% |
| **total** | 2516 | 100% |
| **C-written** | **1765** | **70.2%** |
<!-- STATUS:END -->
