...
**C-written: 62.1% (1562 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1562/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1562 funcs, 62.1%)
- [x] 50% C-written (~1258 funcs) — DONE (1562 funcs, 62.1%)
- [ ] 75% C-written (~1887 funcs) (1562 so far)
...
| real-C (match pending) | 822 | 32.7% |
| asm shell (to do) | 954 | 37.9% |
| **total** | 2516 | 100% |
| **C-written** | **1562** | **62.1%** |
<!-- STATUS:END -->
