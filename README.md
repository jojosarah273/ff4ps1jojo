...
**C-written: 58.5% (1472 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1472/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1472 funcs, 58.5%)
- [x] 50% C-written (~1258 funcs) — DONE (1472 funcs, 58.5%)
- [ ] 75% C-written (~1887 funcs) (1472 so far)
...
| real-C (match pending) | 732 | 29.1% |
| asm shell (to do) | 1044 | 41.5% |
| **total** | 2516 | 100% |
| **C-written** | **1472** | **58.5%** |
<!-- STATUS:END -->
