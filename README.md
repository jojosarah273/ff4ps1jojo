...
**C-written: 57.9% (1456 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1456/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1456 funcs, 57.9%)
- [x] 50% C-written (~1258 funcs) — DONE (1456 funcs, 57.9%)
- [ ] 75% C-written (~1887 funcs) (1456 so far)
...
| real-C (match pending) | 716 | 28.5% |
| asm shell (to do) | 1060 | 42.1% |
| **total** | 2516 | 100% |
| **C-written** | **1456** | **57.9%** |
<!-- STATUS:END -->
