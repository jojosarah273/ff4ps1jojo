...
**C-written: 57.2% (1440 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1440/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1440 funcs, 57.2%)
- [x] 50% C-written (~1258 funcs) — DONE (1440 funcs, 57.2%)
- [ ] 75% C-written (~1887 funcs) (1440 so far)
...
| real-C (match pending) | 700 | 27.8% |
| asm shell (to do) | 1076 | 42.8% |
| **total** | 2516 | 100% |
| **C-written** | **1440** | **57.2%** |
<!-- STATUS:END -->
