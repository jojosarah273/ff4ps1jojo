...
**C-written: 55.8% (1404 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1404/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1404 funcs, 55.8%)
- [x] 50% C-written (~1258 funcs) — DONE (1404 funcs, 55.8%)
- [ ] 75% C-written (~1887 funcs) (1404 so far)
...
| real-C (match pending) | 664 | 26.4% |
| asm shell (to do) | 1112 | 44.2% |
| **total** | 2516 | 100% |
| **C-written** | **1404** | **55.8%** |
<!-- STATUS:END -->
