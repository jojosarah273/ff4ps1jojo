...
**C-written: 68.8% (1732 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1732/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1732 funcs, 68.8%)
- [x] 50% C-written (~1258 funcs) — DONE (1732 funcs, 68.8%)
- [ ] 75% C-written (~1887 funcs) (1732 so far)
...
| real-C (match pending) | 992 | 39.4% |
| asm shell (to do) | 784 | 31.2% |
| **total** | 2516 | 100% |
| **C-written** | **1732** | **68.8%** |
<!-- STATUS:END -->
