...
**C-written: 61.8% (1555 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1555/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1555 funcs, 61.8%)
- [x] 50% C-written (~1258 funcs) — DONE (1555 funcs, 61.8%)
- [ ] 75% C-written (~1887 funcs) (1555 so far)
...
| real-C (match pending) | 815 | 32.4% |
| asm shell (to do) | 961 | 38.2% |
| **total** | 2516 | 100% |
| **C-written** | **1555** | **61.8%** |
<!-- STATUS:END -->
