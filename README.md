...
**C-written: 57.0% (1435 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1435/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1435 funcs, 57.0%)
- [x] 50% C-written (~1258 funcs) — DONE (1435 funcs, 57.0%)
- [ ] 75% C-written (~1887 funcs) (1435 so far)
...
| real-C (match pending) | 695 | 27.6% |
| asm shell (to do) | 1081 | 43.0% |
| **total** | 2516 | 100% |
| **C-written** | **1435** | **57.0%** |
<!-- STATUS:END -->
