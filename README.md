...
**C-written: 79.0% (1988 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1988/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1988 funcs, 79.0%)
- [x] 50% C-written (~1258 funcs) — DONE (1988 funcs, 79.0%)
- [x] 75% C-written (~1887 funcs) — DONE (1988 funcs, 79.0%)
...
| real-C (match pending) | 1248 | 49.6% |
| asm shell (to do) | 528 | 21.0% |
| **total** | 2516 | 100% |
| **C-written** | **1988** | **79.0%** |
<!-- STATUS:END -->
