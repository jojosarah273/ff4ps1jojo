...
**C-written: 64.1% (1614 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1614/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1614 funcs, 64.1%)
- [x] 50% C-written (~1258 funcs) — DONE (1614 funcs, 64.1%)
- [ ] 75% C-written (~1887 funcs) (1614 so far)
...
| real-C (match pending) | 874 | 34.7% |
| asm shell (to do) | 902 | 35.9% |
| **total** | 2516 | 100% |
| **C-written** | **1614** | **64.1%** |
<!-- STATUS:END -->
