...
**C-written: 66.3% (1667 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1667/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1667 funcs, 66.3%)
- [x] 50% C-written (~1258 funcs) — DONE (1667 funcs, 66.3%)
- [ ] 75% C-written (~1887 funcs) (1667 so far)
...
| real-C (match pending) | 927 | 36.8% |
| asm shell (to do) | 849 | 33.7% |
| **total** | 2516 | 100% |
| **C-written** | **1667** | **66.3%** |
<!-- STATUS:END -->
