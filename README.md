...
**C-written: 57.4% (1444 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1444/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1444 funcs, 57.4%)
- [x] 50% C-written (~1258 funcs) — DONE (1444 funcs, 57.4%)
- [ ] 75% C-written (~1887 funcs) (1444 so far)
...
| real-C (match pending) | 704 | 28.0% |
| asm shell (to do) | 1072 | 42.6% |
| **total** | 2516 | 100% |
| **C-written** | **1444** | **57.4%** |
<!-- STATUS:END -->
