...
**C-written: 61.6% (1551 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1551/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1551 funcs, 61.6%)
- [x] 50% C-written (~1258 funcs) — DONE (1551 funcs, 61.6%)
- [ ] 75% C-written (~1887 funcs) (1551 so far)
...
| real-C (match pending) | 811 | 32.2% |
| asm shell (to do) | 965 | 38.4% |
| **total** | 2516 | 100% |
| **C-written** | **1551** | **61.6%** |
<!-- STATUS:END -->
