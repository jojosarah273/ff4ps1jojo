...
**C-written: 76.2% (1918 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1918/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1918 funcs, 76.2%)
- [x] 50% C-written (~1258 funcs) — DONE (1918 funcs, 76.2%)
- [x] 75% C-written (~1887 funcs) — DONE (1918 funcs, 76.2%)
...
| real-C (match pending) | 1178 | 46.8% |
| asm shell (to do) | 598 | 23.8% |
| **total** | 2516 | 100% |
| **C-written** | **1918** | **76.2%** |
<!-- STATUS:END -->
