...
**C-written: 71.2% (1791 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1791/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1791 funcs, 71.2%)
- [x] 50% C-written (~1258 funcs) — DONE (1791 funcs, 71.2%)
- [ ] 75% C-written (~1887 funcs) (1791 so far)
...
| real-C (match pending) | 1051 | 41.8% |
| asm shell (to do) | 725 | 28.8% |
| **total** | 2516 | 100% |
| **C-written** | **1791** | **71.2%** |
<!-- STATUS:END -->
