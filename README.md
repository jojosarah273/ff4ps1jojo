...
**C-written: 52.9% (1330 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1330/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1330 funcs, 52.9%)
- [x] 50% C-written (~1258 funcs) — DONE (1330 funcs, 52.9%)
- [ ] 75% C-written (~1887 funcs) (1330 so far)
...
| real-C (match pending) | 590 | 23.4% |
| asm shell (to do) | 1186 | 47.1% |
| **total** | 2516 | 100% |
| **C-written** | **1330** | **52.9%** |
<!-- STATUS:END -->
