...
**C-written: 58.8% (1480 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1480/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1480 funcs, 58.8%)
- [x] 50% C-written (~1258 funcs) — DONE (1480 funcs, 58.8%)
- [ ] 75% C-written (~1887 funcs) (1480 so far)
...
| real-C (match pending) | 740 | 29.4% |
| asm shell (to do) | 1036 | 41.2% |
| **total** | 2516 | 100% |
| **C-written** | **1480** | **58.8%** |
<!-- STATUS:END -->
