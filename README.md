...
**C-written: 62.6% (1576 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1576/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1576 funcs, 62.6%)
- [x] 50% C-written (~1258 funcs) — DONE (1576 funcs, 62.6%)
- [ ] 75% C-written (~1887 funcs) (1576 so far)
...
| real-C (match pending) | 836 | 33.2% |
| asm shell (to do) | 940 | 37.4% |
| **total** | 2516 | 100% |
| **C-written** | **1576** | **62.6%** |
<!-- STATUS:END -->
