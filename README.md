...
**C-written: 48.1% (1209 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1209/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1209 funcs, 48.1%)
- [ ] 50% C-written (~1258 funcs) (1209 so far)
- [ ] 75% C-written (~1887 funcs) (1209 so far)
...
| real-C (match pending) | 469 | 18.6% |
| asm shell (to do) | 1307 | 51.9% |
| **total** | 2516 | 100% |
| **C-written** | **1209** | **48.1%** |
<!-- STATUS:END -->
