...
**C-written: 68.7% (1728 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1728/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1728 funcs, 68.7%)
- [x] 50% C-written (~1258 funcs) — DONE (1728 funcs, 68.7%)
- [ ] 75% C-written (~1887 funcs) (1728 so far)
...
| real-C (match pending) | 988 | 39.3% |
| asm shell (to do) | 788 | 31.3% |
| **total** | 2516 | 100% |
| **C-written** | **1728** | **68.7%** |
<!-- STATUS:END -->
