...
**C-written: 72.8% (1832 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1832/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1832 funcs, 72.8%)
- [x] 50% C-written (~1258 funcs) — DONE (1832 funcs, 72.8%)
- [ ] 75% C-written (~1887 funcs) (1832 so far)
...
| real-C (match pending) | 1092 | 43.4% |
| asm shell (to do) | 684 | 27.2% |
| **total** | 2516 | 100% |
| **C-written** | **1832** | **72.8%** |
<!-- STATUS:END -->
