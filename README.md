...
**C-written: 64.6% (1625 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1625/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1625 funcs, 64.6%)
- [x] 50% C-written (~1258 funcs) — DONE (1625 funcs, 64.6%)
- [ ] 75% C-written (~1887 funcs) (1625 so far)
...
| real-C (match pending) | 885 | 35.2% |
| asm shell (to do) | 891 | 35.4% |
| **total** | 2516 | 100% |
| **C-written** | **1625** | **64.6%** |
<!-- STATUS:END -->
