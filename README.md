...
**C-written: 48.4% (1219 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1219/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1219 funcs, 48.4%)
- [ ] 50% C-written (~1258 funcs) (1219 so far)
- [ ] 75% C-written (~1887 funcs) (1219 so far)
...
| real-C (match pending) | 479 | 19.0% |
| asm shell (to do) | 1297 | 51.6% |
| **total** | 2516 | 100% |
| **C-written** | **1219** | **48.4%** |
<!-- STATUS:END -->
