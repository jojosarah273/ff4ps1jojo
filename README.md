...
**C-written: 42.2% (1061 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1061/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1061 funcs, 42.2%)
- [ ] 50% C-written (~1258 funcs) (1061 so far)
- [ ] 75% C-written (~1887 funcs) (1061 so far)
...
| real-C (match pending) | 321 | 12.8% |
| asm shell (to do) | 1455 | 57.8% |
| **total** | 2516 | 100% |
| **C-written** | **1061** | **42.2%** |
<!-- STATUS:END -->
