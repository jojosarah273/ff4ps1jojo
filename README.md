...
**C-written: 78.3% (1971 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1971/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1971 funcs, 78.3%)
- [x] 50% C-written (~1258 funcs) — DONE (1971 funcs, 78.3%)
- [x] 75% C-written (~1887 funcs) — DONE (1971 funcs, 78.3%)
...
| real-C (match pending) | 1231 | 48.9% |
| asm shell (to do) | 545 | 21.7% |
| **total** | 2516 | 100% |
| **C-written** | **1971** | **78.3%** |
<!-- STATUS:END -->
