...
**C-written: 65.7% (1653 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1653/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1653 funcs, 65.7%)
- [x] 50% C-written (~1258 funcs) — DONE (1653 funcs, 65.7%)
- [ ] 75% C-written (~1887 funcs) (1653 so far)
...
| real-C (match pending) | 913 | 36.3% |
| asm shell (to do) | 863 | 34.3% |
| **total** | 2516 | 100% |
| **C-written** | **1653** | **65.7%** |
<!-- STATUS:END -->
