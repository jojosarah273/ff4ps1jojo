...
**C-written: 58.5% (1471 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1471/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1471 funcs, 58.5%)
- [x] 50% C-written (~1258 funcs) — DONE (1471 funcs, 58.5%)
- [ ] 75% C-written (~1887 funcs) (1471 so far)
...
| real-C (match pending) | 731 | 29.1% |
| asm shell (to do) | 1045 | 41.5% |
| **total** | 2516 | 100% |
| **C-written** | **1471** | **58.5%** |
<!-- STATUS:END -->
