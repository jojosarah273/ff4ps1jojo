...
**C-written: 84.6% (2129 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (2129/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (2129 funcs, 84.6%)
- [x] 50% C-written (~1258 funcs) — DONE (2129 funcs, 84.6%)
- [x] 75% C-written (~1887 funcs) — DONE (2129 funcs, 84.6%)
...
| real-C (match pending) | 1389 | 55.2% |
| asm shell (to do) | 387 | 15.4% |
| **total** | 2516 | 100% |
| **C-written** | **2129** | **84.6%** |
<!-- STATUS:END -->
