...
**C-written: 62.4% (1570 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1570/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1570 funcs, 62.4%)
- [x] 50% C-written (~1258 funcs) — DONE (1570 funcs, 62.4%)
- [ ] 75% C-written (~1887 funcs) (1570 so far)
...
| real-C (match pending) | 830 | 33.0% |
| asm shell (to do) | 946 | 37.6% |
| **total** | 2516 | 100% |
| **C-written** | **1570** | **62.4%** |
<!-- STATUS:END -->
