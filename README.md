...
**C-written: 93.8% (2359 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (2359/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (2359 funcs, 93.8%)
- [x] 50% C-written (~1258 funcs) — DONE (2359 funcs, 93.8%)
- [x] 75% C-written (~1887 funcs) — DONE (2359 funcs, 93.8%)
...
| real-C (match pending) | 1619 | 64.3% |
| asm shell (to do) | 157 | 6.2% |
| **total** | 2516 | 100% |
| **C-written** | **2359** | **93.8%** |
<!-- STATUS:END -->
