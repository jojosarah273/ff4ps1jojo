...
**C-written: 59.3% (1492 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1492/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1492 funcs, 59.3%)
- [x] 50% C-written (~1258 funcs) — DONE (1492 funcs, 59.3%)
- [ ] 75% C-written (~1887 funcs) (1492 so far)
...
| real-C (match pending) | 752 | 29.9% |
| asm shell (to do) | 1024 | 40.7% |
| **total** | 2516 | 100% |
| **C-written** | **1492** | **59.3%** |
<!-- STATUS:END -->
