...
**C-written: 77.1% (1940 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1940/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1940 funcs, 77.1%)
- [x] 50% C-written (~1258 funcs) — DONE (1940 funcs, 77.1%)
- [x] 75% C-written (~1887 funcs) — DONE (1940 funcs, 77.1%)
...
| real-C (match pending) | 1200 | 47.7% |
| asm shell (to do) | 576 | 22.9% |
| **total** | 2516 | 100% |
| **C-written** | **1940** | **77.1%** |
<!-- STATUS:END -->
