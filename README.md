...
**C-written: 64.4% (1621 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1621/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1621 funcs, 64.4%)
- [x] 50% C-written (~1258 funcs) — DONE (1621 funcs, 64.4%)
- [ ] 75% C-written (~1887 funcs) (1621 so far)
...
| real-C (match pending) | 881 | 35.0% |
| asm shell (to do) | 895 | 35.6% |
| **total** | 2516 | 100% |
| **C-written** | **1621** | **64.4%** |
<!-- STATUS:END -->
