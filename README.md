...
**C-written: 59.3% (1493 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1493/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1493 funcs, 59.3%)
- [x] 50% C-written (~1258 funcs) — DONE (1493 funcs, 59.3%)
- [ ] 75% C-written (~1887 funcs) (1493 so far)
...
| real-C (match pending) | 753 | 29.9% |
| asm shell (to do) | 1023 | 40.7% |
| **total** | 2516 | 100% |
| **C-written** | **1493** | **59.3%** |
<!-- STATUS:END -->
