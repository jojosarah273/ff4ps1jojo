...
**C-written: 60.9% (1531 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1531/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1531 funcs, 60.9%)
- [x] 50% C-written (~1258 funcs) — DONE (1531 funcs, 60.9%)
- [ ] 75% C-written (~1887 funcs) (1531 so far)
...
| real-C (match pending) | 791 | 31.4% |
| asm shell (to do) | 985 | 39.1% |
| **total** | 2516 | 100% |
| **C-written** | **1531** | **60.9%** |
<!-- STATUS:END -->
