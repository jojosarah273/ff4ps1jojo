...
**C-written: 54.8% (1378 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1378/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1378 funcs, 54.8%)
- [x] 50% C-written (~1258 funcs) — DONE (1378 funcs, 54.8%)
- [ ] 75% C-written (~1887 funcs) (1378 so far)
...
| real-C (match pending) | 638 | 25.4% |
| asm shell (to do) | 1138 | 45.2% |
| **total** | 2516 | 100% |
| **C-written** | **1378** | **54.8%** |
<!-- STATUS:END -->
