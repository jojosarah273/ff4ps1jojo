...
**C-written: 52.5% (1320 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1320/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1320 funcs, 52.5%)
- [x] 50% C-written (~1258 funcs) — DONE (1320 funcs, 52.5%)
- [ ] 75% C-written (~1887 funcs) (1320 so far)
...
| real-C (match pending) | 580 | 23.1% |
| asm shell (to do) | 1196 | 47.5% |
| **total** | 2516 | 100% |
| **C-written** | **1320** | **52.5%** |
<!-- STATUS:END -->
