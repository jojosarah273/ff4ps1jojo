...
**C-written: 71.5% (1798 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1798/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1798 funcs, 71.5%)
- [x] 50% C-written (~1258 funcs) — DONE (1798 funcs, 71.5%)
- [ ] 75% C-written (~1887 funcs) (1798 so far)
...
| real-C (match pending) | 1058 | 42.1% |
| asm shell (to do) | 718 | 28.5% |
| **total** | 2516 | 100% |
| **C-written** | **1798** | **71.5%** |
<!-- STATUS:END -->
