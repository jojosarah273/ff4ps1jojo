...
**C-written: 60.9% (1533 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1533/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1533 funcs, 60.9%)
- [x] 50% C-written (~1258 funcs) — DONE (1533 funcs, 60.9%)
- [ ] 75% C-written (~1887 funcs) (1533 so far)
...
| real-C (match pending) | 793 | 31.5% |
| asm shell (to do) | 983 | 39.1% |
| **total** | 2516 | 100% |
| **C-written** | **1533** | **60.9%** |
<!-- STATUS:END -->
