...
**C-written: 74.0% (1863 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1863/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1863 funcs, 74.0%)
- [x] 50% C-written (~1258 funcs) — DONE (1863 funcs, 74.0%)
- [ ] 75% C-written (~1887 funcs) (1863 so far)
...
| real-C (match pending) | 1123 | 44.6% |
| asm shell (to do) | 653 | 26.0% |
| **total** | 2516 | 100% |
| **C-written** | **1863** | **74.0%** |
<!-- STATUS:END -->
