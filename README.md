...
**C-written: 58.9% (1483 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1483/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1483 funcs, 58.9%)
- [x] 50% C-written (~1258 funcs) — DONE (1483 funcs, 58.9%)
- [ ] 75% C-written (~1887 funcs) (1483 so far)
...
| real-C (match pending) | 743 | 29.5% |
| asm shell (to do) | 1033 | 41.1% |
| **total** | 2516 | 100% |
| **C-written** | **1483** | **58.9%** |
<!-- STATUS:END -->
