...
**C-written: 73.2% (1842 funcs) — the Phase A mission is the rest.**
...
| A — Complete C decomp | Every function as harness-verified C (byte-match where the compiler reproduces it; runtime-verified where it doesn't) | ▶ in progress (1842/2516 C-written, 740 byte-verified) |
...
<!-- MILESTONES:BEGIN -->
- [x] 25% C-written (~629 funcs) — DONE (1842 funcs, 73.2%)
- [x] 50% C-written (~1258 funcs) — DONE (1842 funcs, 73.2%)
- [ ] 75% C-written (~1887 funcs) (1842 so far)
...
| real-C (match pending) | 1102 | 43.8% |
| asm shell (to do) | 674 | 26.8% |
| **total** | 2516 | 100% |
| **C-written** | **1842** | **73.2%** |
<!-- STATUS:END -->
