...
## verify
    make build/func_800F3B9C.o && ~/.venvs/ff4_decomp/bin/asm-differ func_800F3B9C -j .text -o -f build/func_800F3B9C.o -F build/expected/func_800F3B9C.o
100% match -> register: cp build/expected/func_800F3B9C.o expected/matched/
and delete the asm spec. Else: `python3 tools/decomp_work.py --restore func_800F3B9C`
...
func_800F3B9C(CPUState* cpu)
{
    ...
    if (cpu->pc != 0u) {
        ...
        switch (_cont) {
            case 0x800F3BB8u: goto block_800F3BB8;
            case 0x800F3BC4u: goto block_800F3BC4;
            case 0x800F3BCCu: goto block_800F3BCC;
            case 0x800F3BD4u: goto block_800F3BD4;
            case 0x800F3BE0u: goto block_800F3BE0;
            case 0x800F3BE8u: goto block_800F3BE8;
            case 0x800F3BF0u: goto block_800F3BF0;
            case 0x800F3C00u: goto block_800F3C00;
            case 0x800F3C08u: goto block_800F3C08;
            case 0x800F3C10u: goto block_800F3C10;
            case 0x800F3C18u: goto block_800F3C18;
            case 0x800F3C30u: goto block_800F3C30;
            default: break;
        }
    }
    debug_server_log_call_entry(0x800F3B9Cu);
    /* Address: 0x800F3B9C, Size: 160 bytes, Blocks: 13 */

block_800F3B9C:
#ifndef PSX_NO_DEBUG_TOOLS
    debug_server_cyc_observe(0x800F3B9Cu);
#endif
#ifdef PSX_COSIM
    cosim_block(0x800F3B9Cu);
#endif
#ifdef PSX_ENABLE_BLOCK_CYCLES
    if (psx_slice_block(cpu, 0x800F3B9Cu, 7u, 0)) return;
#endif
#ifdef PSX_ENABLE_BLOCK_CYCLES
    psx_icache_fetch(cpu, 0x800F3B9
```
