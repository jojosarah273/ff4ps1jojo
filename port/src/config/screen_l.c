...
{
    page_open(0x1B83);
    func_800F56AC(cell_state(0x1B85));
    if (io_just() != 0)
        goto L234;
...
L3C4:
    ...
    func_80120B6C();
    func_8011F684();
    func_800F8F74(0x1B8B);
    func_800F8F74(0x1B8C);
    func_800F8F74(0x1B8D);
    func_800F8F74(0x1B8E);
    func_800F8F74(0x1B8F);
    func_800F8F74(0x1BBB);
L484:
    txt_set(0x1B8A);
    func_8012D1D0();
    if (io_just() == 0)
