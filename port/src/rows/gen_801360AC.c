/* FF4 source-port — interpreted module for ability_when_the_panel_cell_is_run.
 * Ground truth: src/ability_when_the_panel_cell_is_run.c (byte-verified).
...
void ability_when_the_panel_cell_is_run(void)
{
