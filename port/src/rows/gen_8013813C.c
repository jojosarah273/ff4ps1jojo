/* FF4 source-port — interpreted module for stat_table_header_hash_the_byte_co.
 * Ground truth: src/stat_table_header_hash_the_byte_co.c (byte-verified).
...
void stat_table_header_hash_the_byte_co(void)
{
