/* FF4 source-port — interpreted module for battle_sprite_blit_plane_variant_m.
 * Ground truth: src/battle_sprite_blit_plane_variant_m.c (byte-verified).
 * Primitives: port/include/ff4_window.h.
 */
#include "ff4_window.h"
void battle_sprite_blit_plane_variant_m(u32 a0, u16 *src, u32 a2, u32 a3)
{
