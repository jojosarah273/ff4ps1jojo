/* FF4 source-port — interpreted module for battle_cutscene_driver_s2_v0_latch.
 * Ground truth: src/battle_cutscene_driver_s2_v0_latch.c (byte-verified).
 * Primitives: port/include/ff4_window.h.
 */
#include "ff4_window.h"
void battle_cutscene_driver_s2_v0_latch(void)
{
