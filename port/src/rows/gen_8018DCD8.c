/* FF4 source-port — interpreted module for queue_command_state_reset_header_s.
 * Ground truth: src/queue_command_state_reset_header_s.c (byte-verified).
...
void queue_command_state_reset_header_s(void)
{
