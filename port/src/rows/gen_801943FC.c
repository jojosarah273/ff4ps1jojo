/* FF4 source-port — interpreted module for battle_ui_phase_state_hit_box_gate.
 * Ground truth: src/battle_ui_phase_state_hit_box_gate.c (byte-verified).
...
void battle_ui_phase_state_hit_box_gate(u32 a0, s32 *s0)
{
