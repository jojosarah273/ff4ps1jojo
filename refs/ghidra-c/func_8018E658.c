...

{
  ...
  do {
    ...
    *(ushort *)(PTR_VOICE_00_LEFT_RIGHT_8019b114 + unaff_s3 * 2) = param_2 | (ushort)param_1;
    do {
      if ((unaff_s2 != 0) || ((unaff_s1 & 2) != 0)) {
        ...
        *(ushort *)(PTR_VOICE_00_LEFT_RIGHT_8019b114 + unaff_s3 * 2 + 2) = uVar3 | uVar4;
      }
      ...
      if ((unaff_s2 != 0) || ((unaff_s1 & 0x1000) != 0)) {
        ...
        *(ushort *)(PTR_VOICE_00_LEFT_RIGHT_8019b114 + unaff_s3 * 2 + 8) =
             *(ushort *)(PTR_VOICE_00_LEFT_RIGHT_8019b114 + unaff_s3 * 2 + 8) & 0xff0f | uVar4 << 4;
      }
