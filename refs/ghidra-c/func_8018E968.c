      ...
      *(ushort *)(PTR_VOICE_00_LEFT_RIGHT_8019b114 + unaff_s3 * 2 + 10) =
      ...
      do {
        ...
        if ((unaff_s2 != 0) || ((unaff_s1 & 2) != 0)) {
          ...
          *(ushort *)(PTR_VOICE_00_LEFT_RIGHT_8019b114 + unaff_s4 * 0x10 + 2) = uVar3 | uVar4;
        }
        ...
        if ((unaff_s2 != 0) || ((unaff_s1 & 0x20000) != 0)) {
          *(undefined2 *)(PTR_VOICE_00_LEFT_RIGHT_8019b114 + unaff_s4 * 0x10 + 8) =
               *(undefined2 *)((int)unaff_s0 + 0x3a);
        }
        if ((unaff_s2 != 0) || ((unaff_s1 & 0x40000) != 0)) {
          *(short *)(PTR_VOICE_00_LEFT_RIGHT_8019b114 + unaff_s4 * 0x10 + 10) = (short)unaff_s0[0xf]
          ;
        }
        if ((unaff_s2 != 0) || ((unaff_s1 & 0x800) != 0)) {
          ...
          *(ushort *)(PTR_VOICE_00_LEFT_RIGHT_8019b114 + unaff_s4 * 0x10 + 8) =
               *(ushort *)(PTR_VOICE_00_LEFT_RIGHT_8019b114 + unaff_s4 * 0x10 + 8) & 0xff |
               (uVar4 | uVar3) << 8;
        }
        if ((unaff_s2 != 0) || ((unaff_s1 & 0x1000) != 0)) {
          ...
          *(ushort *)(PTR_VOICE_00_LEFT_RIGHT_8019b114 + unaff_s4 * 0x10 + 8) =
               *(ushort *)(PTR_VOICE_00_LEFT_RIGHT_8019b114 + unaff_s4 * 0x10 + 8) & 0xff0f |
               uVar4 << 4;
        }
