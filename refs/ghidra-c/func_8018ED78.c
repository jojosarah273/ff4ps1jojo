...
/* WARNING: Removing unreachable block (ram,0x8018ed88) */
/* WARNING: Removing unreachable block (ram,0x8018ed9c) */
/* WARNING: Removing unreachable block (ram,0x8018eda4) */
/* WARNING: Removing unreachable block (ram,0x8018eda8) */
...

{
  ...
  *(ushort *)(PTR_VOICE_00_LEFT_RIGHT_8019b114 + 0x180) = *(ushort *)(param_1 + 4) & 0x7fff;
  if (in_t2 == 0) {
