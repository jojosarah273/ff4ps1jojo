...
/* WARNING: Removing unreachable block (ram,0x8018ee48) */
/* WARNING: Removing unreachable block (ram,0x8018ee5c) */
/* WARNING: Removing unreachable block (ram,0x8018ee64) */
/* WARNING: Removing unreachable block (ram,0x8018ee68) */
...

{
  ...
  *(ushort *)(PTR_VOICE_00_LEFT_RIGHT_8019b114 + 0x182) = *(ushort *)(param_1 + 6) & 0x7fff;
