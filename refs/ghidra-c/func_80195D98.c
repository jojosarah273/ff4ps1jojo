...
undefined4 SYS_OBJ_1D80(undefined4 *param_1,undefined4 *param_2)

{
  ...
  if (*(short *)(param_1 + 1) < 0) {
    ...
    uVar1 = SYS_OBJ_1DE0(DAT_8019db58);
    return uVar1;
  }
  ...
  *(undefined2 *)(param_1 + 1) = uVar5;
  if (*(short *)((int)param_1 + 6) < 0) {
    ...
    uVar1 = SYS_OBJ_1E1C(DAT_8019db5a);
    return uVar1;
  }
    ...
    while( true ) {
      if ((uVar2 & 0x8000000) != 0) {
        while (iVar4 = iVar4 + -1, iVar4 != -1) {
          *param_2 = *(undefined4 *)PTR_GPU_REG0_8019dc58;
          param_2 = param_2 + 1;
        }
        if (iVar7 != 0) {
